...
/// </summary>
public record class StyleUpdateParams : ParamsBase
{
    ...
    public required IReadOnlyList<Tweet> Tweets
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullStruct<ImmutableArray<Tweet>>("tweets");
        }
        init
        {
            this._rawBodyData.Set<ImmutableArray<Tweet>>(
                "tweets",
...
#pragma warning restore CS8618
    ...
    public static StyleUpdateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string id
    ...
    public virtual bool Equals(StyleUpdateParams? other)
    {
        if (other == null)
        {
            return false;
