...
/// </summary>
public record class MonitorUpdateParams : ParamsBase
{
    ...
    public MonitorUpdateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public MonitorUpdateParams(MonitorUpdateParams monitorUpdateParams)
        : base(monitorUpdateParams)
    {
        this.ID = monitorUpdateParams.ID;

        this._rawBodyData = new(monitorUpdateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static MonitorUpdateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string id
    ...
    public virtual bool Equals(MonitorUpdateParams? other)
    {
        if (other == null)
        {
            return false;
