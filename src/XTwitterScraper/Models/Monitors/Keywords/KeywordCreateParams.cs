...
/// </summary>
public record class KeywordCreateParams : ParamsBase
{
    ...
    public KeywordCreateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public KeywordCreateParams(KeywordCreateParams keywordCreateParams)
        : base(keywordCreateParams)
    {
        this._rawBodyData = new(keywordCreateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static KeywordCreateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(KeywordCreateParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/monitors/keywords")
        {
