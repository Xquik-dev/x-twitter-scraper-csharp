...
public record class DrawListParams : ParamsBase
{
    ...
    public DrawListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public DrawListParams(DrawListParams drawListParams)
        : base(drawListParams) { }
...
#pragma warning restore CS8618
    ...
    public static DrawListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(DrawListParams? other)
    {
        if (other == null)
        {
            return false;
