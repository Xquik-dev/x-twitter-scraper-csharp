...
/// </summary>
public record class DmUpdateParams : ParamsBase
{
    ...
    public DmUpdateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public DmUpdateParams(DmUpdateParams dmUpdateParams)
        : base(dmUpdateParams)
    {
        this.UserID = dmUpdateParams.UserID;

        this._rawBodyData = new(dmUpdateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static DmUpdateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string userID
    ...
    public virtual bool Equals(DmUpdateParams? other)
    {
        if (other == null)
        {
            return false;
