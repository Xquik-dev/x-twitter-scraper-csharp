...
public sealed record class DmSendResponse : JsonModel
{
    ...
    /// </summary>
    public required DmSendResponseAccount? Account
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<DmSendResponseAccount>("account");
        }
    ...
    public required ApiEnum<string, DmSendResponseStatus> Status
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<ApiEnum<string, DmSendResponseStatus>>("status");
        }
...
/// Connected account selected for the write.
/// </summary>
[JsonConverter(typeof(JsonModelConverter<DmSendResponseAccount, DmSendResponseAccountFromRaw>))]
public sealed record class DmSendResponseAccount : JsonModel
{
    public required string ID
    {
        get
    ...
    public DmSendResponseAccount() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public DmSendResponseAccount(DmSendResponseAccount dmSendResponseAccount)
        : base(dmSendResponseAccount) { }
#pragma warning restore CS8618

    public DmSendResponseAccount(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    DmSendResponseAccount(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="DmSendResponseAccountFromRaw.FromRawUnchecked"/>
    public static DmSendResponseAccount FromRawUnchecked(
...
class DmSendResponseAccountFromRaw : IFromRawJson<DmSendResponseAccount>
{
    /// <inheritdoc/>
    public DmSendResponseAccount FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => DmSendResponseAccount.FromRawUnchecked(rawData);
}
...
{
    public required ApiEnum<string, global::XTwitterScraper.Models.X.Dm.Type> Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<
                ApiEnum<string, global::XTwitterScraper.Models.X.Dm.Type>
            >("type");
        }
...
#pragma warning restore CS8618
    ...
    [SetsRequiredMembers]
    public NextAction(ApiEnum<string, global::XTwitterScraper.Models.X.Dm.Type> type)
        : this()
    {
        this.Type = type;
    }
...
sealed class TypeConverter : JsonConverter<global::XTwitterScraper.Models.X.Dm.Type>
{
    public override global::XTwitterScraper.Models.X.Dm.Type Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "poll" => global::XTwitterScraper.Models.X.Dm.Type.Poll,
            "retry" => global::XTwitterScraper.Models.X.Dm.Type.Retry,
            "verify_result" => global::XTwitterScraper.Models.X.Dm.Type.VerifyResult,
            "fix_request" => global::XTwitterScraper.Models.X.Dm.Type.FixRequest,
            _ => (global::XTwitterScraper.Models.X.Dm.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::XTwitterScraper.Models.X.Dm.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::XTwitterScraper.Models.X.Dm.Type.Poll => "poll",
                global::XTwitterScraper.Models.X.Dm.Type.Retry => "retry",
                global::XTwitterScraper.Models.X.Dm.Type.VerifyResult => "verify_result",
                global::XTwitterScraper.Models.X.Dm.Type.FixRequest => "fix_request",
                _ => throw new XTwitterScraperInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
...
[JsonConverter(typeof(DmSendResponseStatusConverter))]
public enum DmSendResponseStatus
{
    Accepted,
    Dispatching,
    PendingConfirmation,
...
sealed class DmSendResponseStatusConverter : JsonConverter<DmSendResponseStatus>
{
    public override DmSendResponseStatus Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "accepted" => DmSendResponseStatus.Accepted,
            "dispatching" => DmSendResponseStatus.Dispatching,
            "pending_confirmation" => DmSendResponseStatus.PendingConfirmation,
            "success" => DmSendResponseStatus.Success,
            "failed" => DmSendResponseStatus.Failed,
            "expired" => DmSendResponseStatus.Expired,
            _ => (DmSendResponseStatus)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        DmSendResponseStatus value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                DmSendResponseStatus.Accepted => "accepted",
                DmSendResponseStatus.Dispatching => "dispatching",
                DmSendResponseStatus.PendingConfirmation => "pending_confirmation",
                DmSendResponseStatus.Success => "success",
                DmSendResponseStatus.Failed => "failed",
                DmSendResponseStatus.Expired => "expired",
                _ => throw new XTwitterScraperInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
