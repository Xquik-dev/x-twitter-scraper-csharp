...
/// </summary>
public record class MediaCreateParams : ParamsBase
{
    ...
    public MediaCreateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public MediaCreateParams(MediaCreateParams mediaCreateParams)
        : base(mediaCreateParams)
    {
        this._rawBodyData = new(mediaCreateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static MediaCreateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, MultipartJsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(MediaCreateParams? other)
    {
        if (other == null)
        {
            return false;
