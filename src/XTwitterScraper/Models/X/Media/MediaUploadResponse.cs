...
public sealed record class MediaUploadResponse : JsonModel
{
    ...
    /// </summary>
    public required MediaUploadResponseAccount? Account
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<MediaUploadResponseAccount>("account");
        }
    ...
    public required ApiEnum<string, MediaUploadResponseStatus> Status
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<ApiEnum<string, MediaUploadResponseStatus>>(
                "status"
            );
        }
...
/// </summary>
[JsonConverter(
    typeof(JsonModelConverter<MediaUploadResponseAccount, MediaUploadResponseAccountFromRaw>)
)]
public sealed record class MediaUploadResponseAccount : JsonModel
{
    public required string ID
    {
        get
    ...
    public MediaUploadResponseAccount() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public MediaUploadResponseAccount(MediaUploadResponseAccount mediaUploadResponseAccount)
        : base(mediaUploadResponseAccount) { }
#pragma warning restore CS8618

    public MediaUploadResponseAccount(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    MediaUploadResponseAccount(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="MediaUploadResponseAccountFromRaw.FromRawUnchecked"/>
    public static MediaUploadResponseAccount FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class MediaUploadResponseAccountFromRaw : IFromRawJson<MediaUploadResponseAccount>
{
    /// <inheritdoc/>
    public MediaUploadResponseAccount FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => MediaUploadResponseAccount.FromRawUnchecked(rawData);
}
...
{
    public required ApiEnum<string, global::XTwitterScraper.Models.X.Media.Type> Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<
                ApiEnum<string, global::XTwitterScraper.Models.X.Media.Type>
            >("type");
        }
...
#pragma warning restore CS8618
    ...
    [SetsRequiredMembers]
    public NextAction(ApiEnum<string, global::XTwitterScraper.Models.X.Media.Type> type)
        : this()
    {
        this.Type = type;
    }
...
sealed class TypeConverter : JsonConverter<global::XTwitterScraper.Models.X.Media.Type>
{
    public override global::XTwitterScraper.Models.X.Media.Type Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "poll" => global::XTwitterScraper.Models.X.Media.Type.Poll,
            "retry" => global::XTwitterScraper.Models.X.Media.Type.Retry,
            "verify_result" => global::XTwitterScraper.Models.X.Media.Type.VerifyResult,
            "fix_request" => global::XTwitterScraper.Models.X.Media.Type.FixRequest,
            _ => (global::XTwitterScraper.Models.X.Media.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::XTwitterScraper.Models.X.Media.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::XTwitterScraper.Models.X.Media.Type.Poll => "poll",
                global::XTwitterScraper.Models.X.Media.Type.Retry => "retry",
                global::XTwitterScraper.Models.X.Media.Type.VerifyResult => "verify_result",
                global::XTwitterScraper.Models.X.Media.Type.FixRequest => "fix_request",
                _ => throw new XTwitterScraperInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
...
[JsonConverter(typeof(MediaUploadResponseStatusConverter))]
public enum MediaUploadResponseStatus
{
    Accepted,
    Dispatching,
    PendingConfirmation,
...
sealed class MediaUploadResponseStatusConverter : JsonConverter<MediaUploadResponseStatus>
{
    public override MediaUploadResponseStatus Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "accepted" => MediaUploadResponseStatus.Accepted,
            "dispatching" => MediaUploadResponseStatus.Dispatching,
            "pending_confirmation" => MediaUploadResponseStatus.PendingConfirmation,
            "success" => MediaUploadResponseStatus.Success,
            "failed" => MediaUploadResponseStatus.Failed,
            "expired" => MediaUploadResponseStatus.Expired,
            _ => (MediaUploadResponseStatus)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        MediaUploadResponseStatus value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                MediaUploadResponseStatus.Accepted => "accepted",
                MediaUploadResponseStatus.Dispatching => "dispatching",
                MediaUploadResponseStatus.PendingConfirmation => "pending_confirmation",
                MediaUploadResponseStatus.Success => "success",
                MediaUploadResponseStatus.Failed => "failed",
                MediaUploadResponseStatus.Expired => "expired",
                _ => throw new XTwitterScraperInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
