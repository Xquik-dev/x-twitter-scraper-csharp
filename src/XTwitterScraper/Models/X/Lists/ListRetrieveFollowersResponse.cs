...
/// </summary>
[JsonConverter(
    typeof(JsonModelConverter<ListRetrieveFollowersResponse, ListRetrieveFollowersResponseFromRaw>)
)]
public sealed record class ListRetrieveFollowersResponse : JsonModel
{
    ...
    public ListRetrieveFollowersResponse() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ListRetrieveFollowersResponse(
        ListRetrieveFollowersResponse listRetrieveFollowersResponse
    )
        : base(listRetrieveFollowersResponse) { }
#pragma warning restore CS8618

    public ListRetrieveFollowersResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    ListRetrieveFollowersResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="ListRetrieveFollowersResponseFromRaw.FromRawUnchecked"/>
    public static ListRetrieveFollowersResponse FromRawUnchecked(
...
class ListRetrieveFollowersResponseFromRaw : IFromRawJson<ListRetrieveFollowersResponse>
{
    /// <inheritdoc/>
    public ListRetrieveFollowersResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => ListRetrieveFollowersResponse.FromRawUnchecked(rawData);
}
