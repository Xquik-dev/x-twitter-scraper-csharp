...
/// </summary>
[JsonConverter(
    typeof(JsonModelConverter<ListRetrieveTweetsResponse, ListRetrieveTweetsResponseFromRaw>)
)]
public sealed record class ListRetrieveTweetsResponse : JsonModel
{
    ...
    public ListRetrieveTweetsResponse() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ListRetrieveTweetsResponse(ListRetrieveTweetsResponse listRetrieveTweetsResponse)
        : base(listRetrieveTweetsResponse) { }
#pragma warning restore CS8618

    public ListRetrieveTweetsResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    ListRetrieveTweetsResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="ListRetrieveTweetsResponseFromRaw.FromRawUnchecked"/>
    public static ListRetrieveTweetsResponse FromRawUnchecked(
...
class ListRetrieveTweetsResponseFromRaw : IFromRawJson<ListRetrieveTweetsResponse>
{
    /// <inheritdoc/>
    public ListRetrieveTweetsResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => ListRetrieveTweetsResponse.FromRawUnchecked(rawData);
}
