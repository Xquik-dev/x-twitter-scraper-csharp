...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        CommunityRetrieveSearchResponseFromRaw
    >)
)]
public sealed record class CommunityRetrieveSearchResponse : JsonModel
{
    ...
    public CommunityRetrieveSearchResponse() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CommunityRetrieveSearchResponse(
        CommunityRetrieveSearchResponse communityRetrieveSearchResponse
    )
        : base(communityRetrieveSearchResponse) { }
#pragma warning restore CS8618

    public CommunityRetrieveSearchResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    CommunityRetrieveSearchResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="CommunityRetrieveSearchResponseFromRaw.FromRawUnchecked"/>
    public static CommunityRetrieveSearchResponse FromRawUnchecked(
...
class CommunityRetrieveSearchResponseFromRaw : IFromRawJson<CommunityRetrieveSearchResponse>
{
    /// <inheritdoc/>
    public CommunityRetrieveSearchResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => CommunityRetrieveSearchResponse.FromRawUnchecked(rawData);
}
