...
/// </summary>
[JsonConverter(typeof(JsonModelConverter<TweetListResponse, TweetListResponseFromRaw>))]
public sealed record class TweetListResponse : JsonModel
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public TweetListResponse(TweetListResponse tweetListResponse)
        : base(tweetListResponse) { }
#pragma warning restore CS8618

    public TweetListResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    TweetListResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="TweetListResponseFromRaw.FromRawUnchecked"/>
    public static TweetListResponse FromRawUnchecked(
...
class TweetListResponseFromRaw : IFromRawJson<TweetListResponse>
{
    /// <inheritdoc/>
    public TweetListResponse FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData) =>
        TweetListResponse.FromRawUnchecked(rawData);
}
