...
public sealed record class JoinCreateResponse : JsonModel
{
    ...
    /// </summary>
    public required JoinCreateResponseAccount? Account
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<JoinCreateResponseAccount>("account");
        }
    ...
    public required ApiEnum<string, JoinCreateResponseStatus> Status
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<ApiEnum<string, JoinCreateResponseStatus>>(
                "status"
            );
        }
...
/// </summary>
[JsonConverter(
    typeof(JsonModelConverter<JoinCreateResponseAccount, JoinCreateResponseAccountFromRaw>)
)]
public sealed record class JoinCreateResponseAccount : JsonModel
{
    public required string ID
    {
        get
    ...
    public JoinCreateResponseAccount() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public JoinCreateResponseAccount(JoinCreateResponseAccount joinCreateResponseAccount)
        : base(joinCreateResponseAccount) { }
#pragma warning restore CS8618

    public JoinCreateResponseAccount(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    JoinCreateResponseAccount(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="JoinCreateResponseAccountFromRaw.FromRawUnchecked"/>
    public static JoinCreateResponseAccount FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class JoinCreateResponseAccountFromRaw : IFromRawJson<JoinCreateResponseAccount>
{
    /// <inheritdoc/>
    public JoinCreateResponseAccount FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => JoinCreateResponseAccount.FromRawUnchecked(rawData);
}
...
{
    public required ApiEnum<string, global::XTwitterScraper.Models.X.Communities.Join.Type> Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<
                ApiEnum<string, global::XTwitterScraper.Models.X.Communities.Join.Type>
            >("type");
        }
...
#pragma warning restore CS8618
    ...
    [SetsRequiredMembers]
    public NextAction(ApiEnum<string, global::XTwitterScraper.Models.X.Communities.Join.Type> type)
        : this()
    {
        this.Type = type;
    }
...
sealed class TypeConverter : JsonConverter<global::XTwitterScraper.Models.X.Communities.Join.Type>
{
    public override global::XTwitterScraper.Models.X.Communities.Join.Type Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "poll" => global::XTwitterScraper.Models.X.Communities.Join.Type.Poll,
            "retry" => global::XTwitterScraper.Models.X.Communities.Join.Type.Retry,
            "verify_result" => global::XTwitterScraper.Models.X.Communities.Join.Type.VerifyResult,
            "fix_request" => global::XTwitterScraper.Models.X.Communities.Join.Type.FixRequest,
            _ => (global::XTwitterScraper.Models.X.Communities.Join.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::XTwitterScraper.Models.X.Communities.Join.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::XTwitterScraper.Models.X.Communities.Join.Type.Poll => "poll",
                global::XTwitterScraper.Models.X.Communities.Join.Type.Retry => "retry",
                global::XTwitterScraper.Models.X.Communities.Join.Type.VerifyResult =>
                    "verify_result",
                global::XTwitterScraper.Models.X.Communities.Join.Type.FixRequest => "fix_request",
                _ => throw new XTwitterScraperInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
...
[JsonConverter(typeof(JoinCreateResponseStatusConverter))]
public enum JoinCreateResponseStatus
{
    Accepted,
    Dispatching,
    PendingConfirmation,
...
sealed class JoinCreateResponseStatusConverter : JsonConverter<JoinCreateResponseStatus>
{
    public override JoinCreateResponseStatus Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "accepted" => JoinCreateResponseStatus.Accepted,
            "dispatching" => JoinCreateResponseStatus.Dispatching,
            "pending_confirmation" => JoinCreateResponseStatus.PendingConfirmation,
            "success" => JoinCreateResponseStatus.Success,
            "failed" => JoinCreateResponseStatus.Failed,
            "expired" => JoinCreateResponseStatus.Expired,
            _ => (JoinCreateResponseStatus)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        JoinCreateResponseStatus value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                JoinCreateResponseStatus.Accepted => "accepted",
                JoinCreateResponseStatus.Dispatching => "dispatching",
                JoinCreateResponseStatus.PendingConfirmation => "pending_confirmation",
                JoinCreateResponseStatus.Success => "success",
                JoinCreateResponseStatus.Failed => "failed",
                JoinCreateResponseStatus.Expired => "expired",
                _ => throw new XTwitterScraperInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
