...
public sealed record class CommunityCreateResponse : JsonModel
{
    ...
    /// </summary>
    public required CommunityCreateResponseAccount? Account
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<CommunityCreateResponseAccount>("account");
        }
    ...
    public required ApiEnum<string, CommunityCreateResponseStatus> Status
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<ApiEnum<string, CommunityCreateResponseStatus>>(
                "status"
            );
        }
...
[JsonConverter(
    typeof(JsonModelConverter<
        CommunityCreateResponseAccount,
        CommunityCreateResponseAccountFromRaw
    >)
)]
public sealed record class CommunityCreateResponseAccount : JsonModel
{
    public required string ID
    {
        get
    ...
    public CommunityCreateResponseAccount() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CommunityCreateResponseAccount(
        CommunityCreateResponseAccount communityCreateResponseAccount
    )
        : base(communityCreateResponseAccount) { }
#pragma warning restore CS8618

    public CommunityCreateResponseAccount(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    CommunityCreateResponseAccount(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="CommunityCreateResponseAccountFromRaw.FromRawUnchecked"/>
    public static CommunityCreateResponseAccount FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class CommunityCreateResponseAccountFromRaw : IFromRawJson<CommunityCreateResponseAccount>
{
    /// <inheritdoc/>
    public CommunityCreateResponseAccount FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => CommunityCreateResponseAccount.FromRawUnchecked(rawData);
}
...
{
    public required ApiEnum<string, global::XTwitterScraper.Models.X.Communities.Type> Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<
                ApiEnum<string, global::XTwitterScraper.Models.X.Communities.Type>
            >("type");
        }
...
#pragma warning restore CS8618
    ...
    [SetsRequiredMembers]
    public NextAction(ApiEnum<string, global::XTwitterScraper.Models.X.Communities.Type> type)
        : this()
    {
        this.Type = type;
    }
...
sealed class TypeConverter : JsonConverter<global::XTwitterScraper.Models.X.Communities.Type>
{
    public override global::XTwitterScraper.Models.X.Communities.Type Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "poll" => global::XTwitterScraper.Models.X.Communities.Type.Poll,
            "retry" => global::XTwitterScraper.Models.X.Communities.Type.Retry,
            "verify_result" => global::XTwitterScraper.Models.X.Communities.Type.VerifyResult,
            "fix_request" => global::XTwitterScraper.Models.X.Communities.Type.FixRequest,
            _ => (global::XTwitterScraper.Models.X.Communities.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::XTwitterScraper.Models.X.Communities.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::XTwitterScraper.Models.X.Communities.Type.Poll => "poll",
                global::XTwitterScraper.Models.X.Communities.Type.Retry => "retry",
                global::XTwitterScraper.Models.X.Communities.Type.VerifyResult => "verify_result",
                global::XTwitterScraper.Models.X.Communities.Type.FixRequest => "fix_request",
                _ => throw new XTwitterScraperInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
...
[JsonConverter(typeof(CommunityCreateResponseStatusConverter))]
public enum CommunityCreateResponseStatus
{
    Accepted,
    Dispatching,
    PendingConfirmation,
...
sealed class CommunityCreateResponseStatusConverter : JsonConverter<CommunityCreateResponseStatus>
{
    public override CommunityCreateResponseStatus Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "accepted" => CommunityCreateResponseStatus.Accepted,
            "dispatching" => CommunityCreateResponseStatus.Dispatching,
            "pending_confirmation" => CommunityCreateResponseStatus.PendingConfirmation,
            "success" => CommunityCreateResponseStatus.Success,
            "failed" => CommunityCreateResponseStatus.Failed,
            "expired" => CommunityCreateResponseStatus.Expired,
            _ => (CommunityCreateResponseStatus)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        CommunityCreateResponseStatus value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                CommunityCreateResponseStatus.Accepted => "accepted",
                CommunityCreateResponseStatus.Dispatching => "dispatching",
                CommunityCreateResponseStatus.PendingConfirmation => "pending_confirmation",
                CommunityCreateResponseStatus.Success => "success",
                CommunityCreateResponseStatus.Failed => "failed",
                CommunityCreateResponseStatus.Expired => "expired",
                _ => throw new XTwitterScraperInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
