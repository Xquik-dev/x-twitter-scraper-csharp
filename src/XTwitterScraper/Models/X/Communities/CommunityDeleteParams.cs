...
/// </summary>
public record class CommunityDeleteParams : ParamsBase
{
    ...
    public required string CommunityName
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullClass<string>("community_name");
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CommunityDeleteParams(CommunityDeleteParams communityDeleteParams)
        : base(communityDeleteParams)
    {
        this.ID = communityDeleteParams.ID;

        this._rawBodyData = new(communityDeleteParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static CommunityDeleteParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string id
    ...
    public virtual bool Equals(CommunityDeleteParams? other)
    {
        if (other == null)
        {
            return false;
