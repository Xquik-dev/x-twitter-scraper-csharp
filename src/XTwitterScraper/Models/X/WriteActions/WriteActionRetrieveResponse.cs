...
public sealed record class WriteActionRetrieveResponse : JsonModel
{
    ...
    /// </summary>
    public required WriteActionRetrieveResponseAccount? Account
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<WriteActionRetrieveResponseAccount>("account");
        }
    ...
    public required ApiEnum<string, WriteActionRetrieveResponseStatus> Status
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<
                ApiEnum<string, WriteActionRetrieveResponseStatus>
            >("status");
        }
...
[JsonConverter(
    typeof(JsonModelConverter<
        WriteActionRetrieveResponseAccount,
        WriteActionRetrieveResponseAccountFromRaw
    >)
)]
public sealed record class WriteActionRetrieveResponseAccount : JsonModel
{
    public required string ID
    {
        get
    ...
    public WriteActionRetrieveResponseAccount() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public WriteActionRetrieveResponseAccount(
        WriteActionRetrieveResponseAccount writeActionRetrieveResponseAccount
    )
        : base(writeActionRetrieveResponseAccount) { }
#pragma warning restore CS8618

    public WriteActionRetrieveResponseAccount(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    WriteActionRetrieveResponseAccount(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="WriteActionRetrieveResponseAccountFromRaw.FromRawUnchecked"/>
    public static WriteActionRetrieveResponseAccount FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class WriteActionRetrieveResponseAccountFromRaw : IFromRawJson<WriteActionRetrieveResponseAccount>
{
    /// <inheritdoc/>
    public WriteActionRetrieveResponseAccount FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => WriteActionRetrieveResponseAccount.FromRawUnchecked(rawData);
}
...
{
    public required ApiEnum<string, global::XTwitterScraper.Models.X.WriteActions.Type> Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<
                ApiEnum<string, global::XTwitterScraper.Models.X.WriteActions.Type>
            >("type");
        }
...
#pragma warning restore CS8618
    ...
    [SetsRequiredMembers]
    public NextAction(ApiEnum<string, global::XTwitterScraper.Models.X.WriteActions.Type> type)
        : this()
    {
        this.Type = type;
    }
...
sealed class TypeConverter : JsonConverter<global::XTwitterScraper.Models.X.WriteActions.Type>
{
    public override global::XTwitterScraper.Models.X.WriteActions.Type Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "poll" => global::XTwitterScraper.Models.X.WriteActions.Type.Poll,
            "retry" => global::XTwitterScraper.Models.X.WriteActions.Type.Retry,
            "verify_result" => global::XTwitterScraper.Models.X.WriteActions.Type.VerifyResult,
            "fix_request" => global::XTwitterScraper.Models.X.WriteActions.Type.FixRequest,
            _ => (global::XTwitterScraper.Models.X.WriteActions.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::XTwitterScraper.Models.X.WriteActions.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::XTwitterScraper.Models.X.WriteActions.Type.Poll => "poll",
                global::XTwitterScraper.Models.X.WriteActions.Type.Retry => "retry",
                global::XTwitterScraper.Models.X.WriteActions.Type.VerifyResult => "verify_result",
                global::XTwitterScraper.Models.X.WriteActions.Type.FixRequest => "fix_request",
                _ => throw new XTwitterScraperInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
...
[JsonConverter(typeof(WriteActionRetrieveResponseStatusConverter))]
public enum WriteActionRetrieveResponseStatus
{
    Accepted,
    Dispatching,
    PendingConfirmation,
...
sealed class WriteActionRetrieveResponseStatusConverter
    : JsonConverter<WriteActionRetrieveResponseStatus>
{
    public override WriteActionRetrieveResponseStatus Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "accepted" => WriteActionRetrieveResponseStatus.Accepted,
            "dispatching" => WriteActionRetrieveResponseStatus.Dispatching,
            "pending_confirmation" => WriteActionRetrieveResponseStatus.PendingConfirmation,
            "success" => WriteActionRetrieveResponseStatus.Success,
            "failed" => WriteActionRetrieveResponseStatus.Failed,
            "expired" => WriteActionRetrieveResponseStatus.Expired,
            _ => (WriteActionRetrieveResponseStatus)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        WriteActionRetrieveResponseStatus value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                WriteActionRetrieveResponseStatus.Accepted => "accepted",
                WriteActionRetrieveResponseStatus.Dispatching => "dispatching",
                WriteActionRetrieveResponseStatus.PendingConfirmation => "pending_confirmation",
                WriteActionRetrieveResponseStatus.Success => "success",
                WriteActionRetrieveResponseStatus.Failed => "failed",
                WriteActionRetrieveResponseStatus.Expired => "expired",
                _ => throw new XTwitterScraperInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
