...
/// </summary>
public record class FollowDeleteAllParams : ParamsBase
{
...
#pragma warning restore CS8618
    ...
    public static FollowDeleteAllParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string id
    ...
    public virtual bool Equals(FollowDeleteAllParams? other)
    {
        if (other == null)
        {
            return false;
