...
/// </summary>
[JsonConverter(typeof(JsonModelConverter<FollowCreateResponse, FollowCreateResponseFromRaw>))]
public sealed record class FollowCreateResponse : JsonModel
{
    ...
    /// </summary>
    public required FollowCreateResponseAccount? Account
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<FollowCreateResponseAccount>("account");
        }
    ...
    public required ApiEnum<string, FollowCreateResponseStatus> Status
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<ApiEnum<string, FollowCreateResponseStatus>>(
                "status"
            );
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public FollowCreateResponse(FollowCreateResponse followCreateResponse)
        : base(followCreateResponse) { }
#pragma warning restore CS8618

    public FollowCreateResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    FollowCreateResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="FollowCreateResponseFromRaw.FromRawUnchecked"/>
    public static FollowCreateResponse FromRawUnchecked(
...
class FollowCreateResponseFromRaw : IFromRawJson<FollowCreateResponse>
{
    /// <inheritdoc/>
    public FollowCreateResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => FollowCreateResponse.FromRawUnchecked(rawData);
}
...
/// </summary>
[JsonConverter(
    typeof(JsonModelConverter<FollowCreateResponseAccount, FollowCreateResponseAccountFromRaw>)
)]
public sealed record class FollowCreateResponseAccount : JsonModel
{
    public required string ID
    {
        get
    ...
    public FollowCreateResponseAccount() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public FollowCreateResponseAccount(FollowCreateResponseAccount followCreateResponseAccount)
        : base(followCreateResponseAccount) { }
#pragma warning restore CS8618

    public FollowCreateResponseAccount(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    FollowCreateResponseAccount(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="FollowCreateResponseAccountFromRaw.FromRawUnchecked"/>
    public static FollowCreateResponseAccount FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class FollowCreateResponseAccountFromRaw : IFromRawJson<FollowCreateResponseAccount>
{
    /// <inheritdoc/>
    public FollowCreateResponseAccount FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => FollowCreateResponseAccount.FromRawUnchecked(rawData);
}
...
{
    public required ApiEnum<string, global::XTwitterScraper.Models.X.Users.Follow.Type> Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<
                ApiEnum<string, global::XTwitterScraper.Models.X.Users.Follow.Type>
            >("type");
        }
...
#pragma warning restore CS8618
    ...
    [SetsRequiredMembers]
    public NextAction(ApiEnum<string, global::XTwitterScraper.Models.X.Users.Follow.Type> type)
        : this()
    {
        this.Type = type;
    }
...
sealed class TypeConverter : JsonConverter<global::XTwitterScraper.Models.X.Users.Follow.Type>
{
    public override global::XTwitterScraper.Models.X.Users.Follow.Type Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "poll" => global::XTwitterScraper.Models.X.Users.Follow.Type.Poll,
            "retry" => global::XTwitterScraper.Models.X.Users.Follow.Type.Retry,
            "verify_result" => global::XTwitterScraper.Models.X.Users.Follow.Type.VerifyResult,
            "fix_request" => global::XTwitterScraper.Models.X.Users.Follow.Type.FixRequest,
            _ => (global::XTwitterScraper.Models.X.Users.Follow.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::XTwitterScraper.Models.X.Users.Follow.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::XTwitterScraper.Models.X.Users.Follow.Type.Poll => "poll",
                global::XTwitterScraper.Models.X.Users.Follow.Type.Retry => "retry",
                global::XTwitterScraper.Models.X.Users.Follow.Type.VerifyResult => "verify_result",
                global::XTwitterScraper.Models.X.Users.Follow.Type.FixRequest => "fix_request",
                _ => throw new XTwitterScraperInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
...
[JsonConverter(typeof(FollowCreateResponseStatusConverter))]
public enum FollowCreateResponseStatus
{
    Accepted,
    Dispatching,
    PendingConfirmation,
...
sealed class FollowCreateResponseStatusConverter : JsonConverter<FollowCreateResponseStatus>
{
    public override FollowCreateResponseStatus Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "accepted" => FollowCreateResponseStatus.Accepted,
            "dispatching" => FollowCreateResponseStatus.Dispatching,
            "pending_confirmation" => FollowCreateResponseStatus.PendingConfirmation,
            "success" => FollowCreateResponseStatus.Success,
            "failed" => FollowCreateResponseStatus.Failed,
            "expired" => FollowCreateResponseStatus.Expired,
            _ => (FollowCreateResponseStatus)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        FollowCreateResponseStatus value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                FollowCreateResponseStatus.Accepted => "accepted",
                FollowCreateResponseStatus.Dispatching => "dispatching",
                FollowCreateResponseStatus.PendingConfirmation => "pending_confirmation",
                FollowCreateResponseStatus.Success => "success",
                FollowCreateResponseStatus.Failed => "failed",
                FollowCreateResponseStatus.Expired => "expired",
                _ => throw new XTwitterScraperInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
