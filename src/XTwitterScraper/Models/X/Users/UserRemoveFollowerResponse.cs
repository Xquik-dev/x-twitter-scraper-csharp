...
public sealed record class UserRemoveFollowerResponse : JsonModel
{
    ...
    /// </summary>
    public required UserRemoveFollowerResponseAccount? Account
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<UserRemoveFollowerResponseAccount>("account");
        }
    ...
    public required ApiEnum<string, UserRemoveFollowerResponseStatus> Status
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<ApiEnum<string, UserRemoveFollowerResponseStatus>>(
                "status"
            );
        }
...
[JsonConverter(
    typeof(JsonModelConverter<
        UserRemoveFollowerResponseAccount,
        UserRemoveFollowerResponseAccountFromRaw
    >)
)]
public sealed record class UserRemoveFollowerResponseAccount : JsonModel
{
    public required string ID
    {
        get
    ...
    public UserRemoveFollowerResponseAccount() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public UserRemoveFollowerResponseAccount(
        UserRemoveFollowerResponseAccount userRemoveFollowerResponseAccount
    )
        : base(userRemoveFollowerResponseAccount) { }
#pragma warning restore CS8618

    public UserRemoveFollowerResponseAccount(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    UserRemoveFollowerResponseAccount(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="UserRemoveFollowerResponseAccountFromRaw.FromRawUnchecked"/>
    public static UserRemoveFollowerResponseAccount FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class UserRemoveFollowerResponseAccountFromRaw : IFromRawJson<UserRemoveFollowerResponseAccount>
{
    /// <inheritdoc/>
    public UserRemoveFollowerResponseAccount FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => UserRemoveFollowerResponseAccount.FromRawUnchecked(rawData);
}
...
{
    public required ApiEnum<string, global::XTwitterScraper.Models.X.Users.Type> Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<
                ApiEnum<string, global::XTwitterScraper.Models.X.Users.Type>
            >("type");
        }
...
#pragma warning restore CS8618
    ...
    [SetsRequiredMembers]
    public NextAction(ApiEnum<string, global::XTwitterScraper.Models.X.Users.Type> type)
        : this()
    {
        this.Type = type;
    }
...
sealed class TypeConverter : JsonConverter<global::XTwitterScraper.Models.X.Users.Type>
{
    public override global::XTwitterScraper.Models.X.Users.Type Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "poll" => global::XTwitterScraper.Models.X.Users.Type.Poll,
            "retry" => global::XTwitterScraper.Models.X.Users.Type.Retry,
            "verify_result" => global::XTwitterScraper.Models.X.Users.Type.VerifyResult,
            "fix_request" => global::XTwitterScraper.Models.X.Users.Type.FixRequest,
            _ => (global::XTwitterScraper.Models.X.Users.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::XTwitterScraper.Models.X.Users.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::XTwitterScraper.Models.X.Users.Type.Poll => "poll",
                global::XTwitterScraper.Models.X.Users.Type.Retry => "retry",
                global::XTwitterScraper.Models.X.Users.Type.VerifyResult => "verify_result",
                global::XTwitterScraper.Models.X.Users.Type.FixRequest => "fix_request",
                _ => throw new XTwitterScraperInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
...
[JsonConverter(typeof(UserRemoveFollowerResponseStatusConverter))]
public enum UserRemoveFollowerResponseStatus
{
    Accepted,
    Dispatching,
    PendingConfirmation,
...
sealed class UserRemoveFollowerResponseStatusConverter
    : JsonConverter<UserRemoveFollowerResponseStatus>
{
    public override UserRemoveFollowerResponseStatus Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "accepted" => UserRemoveFollowerResponseStatus.Accepted,
            "dispatching" => UserRemoveFollowerResponseStatus.Dispatching,
            "pending_confirmation" => UserRemoveFollowerResponseStatus.PendingConfirmation,
            "success" => UserRemoveFollowerResponseStatus.Success,
            "failed" => UserRemoveFollowerResponseStatus.Failed,
            "expired" => UserRemoveFollowerResponseStatus.Expired,
            _ => (UserRemoveFollowerResponseStatus)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        UserRemoveFollowerResponseStatus value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                UserRemoveFollowerResponseStatus.Accepted => "accepted",
                UserRemoveFollowerResponseStatus.Dispatching => "dispatching",
                UserRemoveFollowerResponseStatus.PendingConfirmation => "pending_confirmation",
                UserRemoveFollowerResponseStatus.Success => "success",
                UserRemoveFollowerResponseStatus.Failed => "failed",
                UserRemoveFollowerResponseStatus.Expired => "expired",
                _ => throw new XTwitterScraperInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
