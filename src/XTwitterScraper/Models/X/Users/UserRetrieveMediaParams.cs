...
/// </summary>
public record class UserRetrieveMediaParams : ParamsBase
{
    ...
    /// </summary>
    public ApiEnum<string, UserRetrieveMediaParamsMediaType>? MediaType
    {
        get
        {
            this._rawQueryData.Freeze();
    ...
    /// Quote mode.
    /// </summary>
    public ApiEnum<string, UserRetrieveMediaParamsQuotes>? Quotes
    {
        get
        {
            this._rawQueryData.Freeze();
    ...
    /// Reply mode.
    /// </summary>
    public ApiEnum<string, UserRetrieveMediaParamsReplies>? Replies
    {
        get
        {
            this._rawQueryData.Freeze();
    ...
    /// Retweet mode.
    /// </summary>
    public ApiEnum<string, UserRetrieveMediaParamsRetweets>? Retweets
    {
        get
        {
            this._rawQueryData.Freeze();
    ...
    public UserRetrieveMediaParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public UserRetrieveMediaParams(UserRetrieveMediaParams userRetrieveMediaParams)
        : base(userRetrieveMediaParams)
    {
        this.ID = userRetrieveMediaParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static UserRetrieveMediaParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(UserRetrieveMediaParams? other)
    {
        if (other == null)
        {
            return false;
...
/// Filter by media type.
/// </summary>
[JsonConverter(typeof(UserRetrieveMediaParamsMediaTypeConverter))]
public enum UserRetrieveMediaParamsMediaType
{
    Images,
    Videos,
    Gifs,
...
sealed class UserRetrieveMediaParamsMediaTypeConverter
    : JsonConverter<UserRetrieveMediaParamsMediaType>
{
    public override UserRetrieveMediaParamsMediaType Read(
    ...
    )
    {
        ...
        {
            "images" => UserRetrieveMediaParamsMediaType.Images,
            "videos" => UserRetrieveMediaParamsMediaType.Videos,
            "gifs" => UserRetrieveMediaParamsMediaType.Gifs,
            "media" => UserRetrieveMediaParamsMediaType.Media,
            "links" => UserRetrieveMediaParamsMediaType.Links,
            "none" => UserRetrieveMediaParamsMediaType.None,
            _ => (UserRetrieveMediaParamsMediaType)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        UserRetrieveMediaParamsMediaType value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                UserRetrieveMediaParamsMediaType.Images => "images",
                UserRetrieveMediaParamsMediaType.Videos => "videos",
                UserRetrieveMediaParamsMediaType.Gifs => "gifs",
                UserRetrieveMediaParamsMediaType.Media => "media",
                UserRetrieveMediaParamsMediaType.Links => "links",
                UserRetrieveMediaParamsMediaType.None => "none",
...
/// Quote mode.
/// </summary>
[JsonConverter(typeof(UserRetrieveMediaParamsQuotesConverter))]
public enum UserRetrieveMediaParamsQuotes
{
    Include,
    Exclude,
    Only,
...
sealed class UserRetrieveMediaParamsQuotesConverter : JsonConverter<UserRetrieveMediaParamsQuotes>
{
    public override UserRetrieveMediaParamsQuotes Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "include" => UserRetrieveMediaParamsQuotes.Include,
            "exclude" => UserRetrieveMediaParamsQuotes.Exclude,
            "only" => UserRetrieveMediaParamsQuotes.Only,
            _ => (UserRetrieveMediaParamsQuotes)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        UserRetrieveMediaParamsQuotes value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                UserRetrieveMediaParamsQuotes.Include => "include",
                UserRetrieveMediaParamsQuotes.Exclude => "exclude",
                UserRetrieveMediaParamsQuotes.Only => "only",
                _ => throw new XTwitterScraperInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
...
/// Reply mode.
/// </summary>
[JsonConverter(typeof(UserRetrieveMediaParamsRepliesConverter))]
public enum UserRetrieveMediaParamsReplies
{
    Include,
    Exclude,
    Only,
...
sealed class UserRetrieveMediaParamsRepliesConverter : JsonConverter<UserRetrieveMediaParamsReplies>
{
    public override UserRetrieveMediaParamsReplies Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "include" => UserRetrieveMediaParamsReplies.Include,
            "exclude" => UserRetrieveMediaParamsReplies.Exclude,
            "only" => UserRetrieveMediaParamsReplies.Only,
            _ => (UserRetrieveMediaParamsReplies)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        UserRetrieveMediaParamsReplies value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                UserRetrieveMediaParamsReplies.Include => "include",
                UserRetrieveMediaParamsReplies.Exclude => "exclude",
                UserRetrieveMediaParamsReplies.Only => "only",
                _ => throw new XTwitterScraperInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
...
/// Retweet mode.
/// </summary>
[JsonConverter(typeof(UserRetrieveMediaParamsRetweetsConverter))]
public enum UserRetrieveMediaParamsRetweets
{
    Include,
    Exclude,
    Only,
...
sealed class UserRetrieveMediaParamsRetweetsConverter
    : JsonConverter<UserRetrieveMediaParamsRetweets>
{
    public override UserRetrieveMediaParamsRetweets Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "include" => UserRetrieveMediaParamsRetweets.Include,
            "exclude" => UserRetrieveMediaParamsRetweets.Exclude,
            "only" => UserRetrieveMediaParamsRetweets.Only,
            _ => (UserRetrieveMediaParamsRetweets)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        UserRetrieveMediaParamsRetweets value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                UserRetrieveMediaParamsRetweets.Include => "include",
                UserRetrieveMediaParamsRetweets.Exclude => "exclude",
                UserRetrieveMediaParamsRetweets.Only => "only",
                _ => throw new XTwitterScraperInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
