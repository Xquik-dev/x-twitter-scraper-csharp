...
/// </summary>
public record class ProfileUpdateAvatarParams : ParamsBase
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ProfileUpdateAvatarParams(ProfileUpdateAvatarParams profileUpdateAvatarParams)
        : base(profileUpdateAvatarParams)
    {
        this._rawBodyData = new(profileUpdateAvatarParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static ProfileUpdateAvatarParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, MultipartJsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(ProfileUpdateAvatarParams? other)
    {
        if (other == null)
        {
            return false;
