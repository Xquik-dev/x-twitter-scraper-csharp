...
public sealed record class ProfileUpdateResponse : JsonModel
{
    ...
    /// </summary>
    public required ProfileUpdateResponseAccount? Account
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<ProfileUpdateResponseAccount>("account");
        }
    ...
    public required ApiEnum<string, ProfileUpdateResponseStatus> Status
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<ApiEnum<string, ProfileUpdateResponseStatus>>(
                "status"
            );
        }
...
/// </summary>
[JsonConverter(
    typeof(JsonModelConverter<ProfileUpdateResponseAccount, ProfileUpdateResponseAccountFromRaw>)
)]
public sealed record class ProfileUpdateResponseAccount : JsonModel
{
    public required string ID
    {
        get
    ...
    public ProfileUpdateResponseAccount() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ProfileUpdateResponseAccount(ProfileUpdateResponseAccount profileUpdateResponseAccount)
        : base(profileUpdateResponseAccount) { }
#pragma warning restore CS8618

    public ProfileUpdateResponseAccount(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    ProfileUpdateResponseAccount(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="ProfileUpdateResponseAccountFromRaw.FromRawUnchecked"/>
    public static ProfileUpdateResponseAccount FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class ProfileUpdateResponseAccountFromRaw : IFromRawJson<ProfileUpdateResponseAccount>
{
    /// <inheritdoc/>
    public ProfileUpdateResponseAccount FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => ProfileUpdateResponseAccount.FromRawUnchecked(rawData);
}
...
{
    public required ApiEnum<string, global::XTwitterScraper.Models.X.Profile.Type> Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<
                ApiEnum<string, global::XTwitterScraper.Models.X.Profile.Type>
            >("type");
        }
...
#pragma warning restore CS8618
    ...
    [SetsRequiredMembers]
    public NextAction(ApiEnum<string, global::XTwitterScraper.Models.X.Profile.Type> type)
        : this()
    {
        this.Type = type;
    }
...
sealed class TypeConverter : JsonConverter<global::XTwitterScraper.Models.X.Profile.Type>
{
    public override global::XTwitterScraper.Models.X.Profile.Type Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "poll" => global::XTwitterScraper.Models.X.Profile.Type.Poll,
            "retry" => global::XTwitterScraper.Models.X.Profile.Type.Retry,
            "verify_result" => global::XTwitterScraper.Models.X.Profile.Type.VerifyResult,
            "fix_request" => global::XTwitterScraper.Models.X.Profile.Type.FixRequest,
            _ => (global::XTwitterScraper.Models.X.Profile.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::XTwitterScraper.Models.X.Profile.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::XTwitterScraper.Models.X.Profile.Type.Poll => "poll",
                global::XTwitterScraper.Models.X.Profile.Type.Retry => "retry",
                global::XTwitterScraper.Models.X.Profile.Type.VerifyResult => "verify_result",
                global::XTwitterScraper.Models.X.Profile.Type.FixRequest => "fix_request",
                _ => throw new XTwitterScraperInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
...
[JsonConverter(typeof(ProfileUpdateResponseStatusConverter))]
public enum ProfileUpdateResponseStatus
{
    Accepted,
    Dispatching,
    PendingConfirmation,
...
sealed class ProfileUpdateResponseStatusConverter : JsonConverter<ProfileUpdateResponseStatus>
{
    public override ProfileUpdateResponseStatus Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "accepted" => ProfileUpdateResponseStatus.Accepted,
            "dispatching" => ProfileUpdateResponseStatus.Dispatching,
            "pending_confirmation" => ProfileUpdateResponseStatus.PendingConfirmation,
            "success" => ProfileUpdateResponseStatus.Success,
            "failed" => ProfileUpdateResponseStatus.Failed,
            "expired" => ProfileUpdateResponseStatus.Expired,
            _ => (ProfileUpdateResponseStatus)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        ProfileUpdateResponseStatus value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                ProfileUpdateResponseStatus.Accepted => "accepted",
                ProfileUpdateResponseStatus.Dispatching => "dispatching",
                ProfileUpdateResponseStatus.PendingConfirmation => "pending_confirmation",
                ProfileUpdateResponseStatus.Success => "success",
                ProfileUpdateResponseStatus.Failed => "failed",
                ProfileUpdateResponseStatus.Expired => "expired",
                _ => throw new XTwitterScraperInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
