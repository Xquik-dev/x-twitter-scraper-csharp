...
public sealed record class LikeCreateResponse : JsonModel
{
    ...
    /// </summary>
    public required LikeCreateResponseAccount? Account
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<LikeCreateResponseAccount>("account");
        }
    ...
    public required ApiEnum<string, LikeCreateResponseStatus> Status
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<ApiEnum<string, LikeCreateResponseStatus>>(
                "status"
            );
        }
...
/// </summary>
[JsonConverter(
    typeof(JsonModelConverter<LikeCreateResponseAccount, LikeCreateResponseAccountFromRaw>)
)]
public sealed record class LikeCreateResponseAccount : JsonModel
{
    public required string ID
    {
        get
    ...
    public LikeCreateResponseAccount() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public LikeCreateResponseAccount(LikeCreateResponseAccount likeCreateResponseAccount)
        : base(likeCreateResponseAccount) { }
#pragma warning restore CS8618

    public LikeCreateResponseAccount(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    LikeCreateResponseAccount(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="LikeCreateResponseAccountFromRaw.FromRawUnchecked"/>
    public static LikeCreateResponseAccount FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class LikeCreateResponseAccountFromRaw : IFromRawJson<LikeCreateResponseAccount>
{
    /// <inheritdoc/>
    public LikeCreateResponseAccount FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => LikeCreateResponseAccount.FromRawUnchecked(rawData);
}
...
{
    public required ApiEnum<string, global::XTwitterScraper.Models.X.Tweets.Like.Type> Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<
                ApiEnum<string, global::XTwitterScraper.Models.X.Tweets.Like.Type>
            >("type");
        }
...
#pragma warning restore CS8618
    ...
    [SetsRequiredMembers]
    public NextAction(ApiEnum<string, global::XTwitterScraper.Models.X.Tweets.Like.Type> type)
        : this()
    {
        this.Type = type;
    }
...
sealed class TypeConverter : JsonConverter<global::XTwitterScraper.Models.X.Tweets.Like.Type>
{
    public override global::XTwitterScraper.Models.X.Tweets.Like.Type Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "poll" => global::XTwitterScraper.Models.X.Tweets.Like.Type.Poll,
            "retry" => global::XTwitterScraper.Models.X.Tweets.Like.Type.Retry,
            "verify_result" => global::XTwitterScraper.Models.X.Tweets.Like.Type.VerifyResult,
            "fix_request" => global::XTwitterScraper.Models.X.Tweets.Like.Type.FixRequest,
            _ => (global::XTwitterScraper.Models.X.Tweets.Like.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::XTwitterScraper.Models.X.Tweets.Like.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::XTwitterScraper.Models.X.Tweets.Like.Type.Poll => "poll",
                global::XTwitterScraper.Models.X.Tweets.Like.Type.Retry => "retry",
                global::XTwitterScraper.Models.X.Tweets.Like.Type.VerifyResult => "verify_result",
                global::XTwitterScraper.Models.X.Tweets.Like.Type.FixRequest => "fix_request",
                _ => throw new XTwitterScraperInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
...
[JsonConverter(typeof(LikeCreateResponseStatusConverter))]
public enum LikeCreateResponseStatus
{
    Accepted,
    Dispatching,
    PendingConfirmation,
...
sealed class LikeCreateResponseStatusConverter : JsonConverter<LikeCreateResponseStatus>
{
    public override LikeCreateResponseStatus Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "accepted" => LikeCreateResponseStatus.Accepted,
            "dispatching" => LikeCreateResponseStatus.Dispatching,
            "pending_confirmation" => LikeCreateResponseStatus.PendingConfirmation,
            "success" => LikeCreateResponseStatus.Success,
            "failed" => LikeCreateResponseStatus.Failed,
            "expired" => LikeCreateResponseStatus.Expired,
            _ => (LikeCreateResponseStatus)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        LikeCreateResponseStatus value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                LikeCreateResponseStatus.Accepted => "accepted",
                LikeCreateResponseStatus.Dispatching => "dispatching",
                LikeCreateResponseStatus.PendingConfirmation => "pending_confirmation",
                LikeCreateResponseStatus.Success => "success",
                LikeCreateResponseStatus.Failed => "failed",
                LikeCreateResponseStatus.Expired => "expired",
                _ => throw new XTwitterScraperInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
