...
/// </summary>
public record class LikeDeleteParams : ParamsBase
{
...
#pragma warning restore CS8618
    ...
    public static LikeDeleteParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string id
    ...
    public virtual bool Equals(LikeDeleteParams? other)
    {
        if (other == null)
        {
            return false;
