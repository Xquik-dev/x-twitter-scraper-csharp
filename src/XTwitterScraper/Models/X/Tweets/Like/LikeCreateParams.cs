...
/// </summary>
public record class LikeCreateParams : ParamsBase
{
    ...
    public LikeCreateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public LikeCreateParams(LikeCreateParams likeCreateParams)
        : base(likeCreateParams)
    {
        this.TweetID = likeCreateParams.TweetID;

        this._rawBodyData = new(likeCreateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static LikeCreateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string tweetID
    ...
    public virtual bool Equals(LikeCreateParams? other)
    {
        if (other == null)
        {
            return false;
