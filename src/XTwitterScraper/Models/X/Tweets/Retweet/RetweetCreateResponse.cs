...
public sealed record class RetweetCreateResponse : JsonModel
{
    ...
    /// </summary>
    public required RetweetCreateResponseAccount? Account
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<RetweetCreateResponseAccount>("account");
        }
    ...
    public required ApiEnum<string, RetweetCreateResponseStatus> Status
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<ApiEnum<string, RetweetCreateResponseStatus>>(
                "status"
            );
        }
...
/// </summary>
[JsonConverter(
    typeof(JsonModelConverter<RetweetCreateResponseAccount, RetweetCreateResponseAccountFromRaw>)
)]
public sealed record class RetweetCreateResponseAccount : JsonModel
{
    public required string ID
    {
        get
    ...
    public RetweetCreateResponseAccount() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public RetweetCreateResponseAccount(RetweetCreateResponseAccount retweetCreateResponseAccount)
        : base(retweetCreateResponseAccount) { }
#pragma warning restore CS8618

    public RetweetCreateResponseAccount(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    RetweetCreateResponseAccount(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="RetweetCreateResponseAccountFromRaw.FromRawUnchecked"/>
    public static RetweetCreateResponseAccount FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class RetweetCreateResponseAccountFromRaw : IFromRawJson<RetweetCreateResponseAccount>
{
    /// <inheritdoc/>
    public RetweetCreateResponseAccount FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => RetweetCreateResponseAccount.FromRawUnchecked(rawData);
}
...
{
    public required ApiEnum<string, global::XTwitterScraper.Models.X.Tweets.Retweet.Type> Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<
                ApiEnum<string, global::XTwitterScraper.Models.X.Tweets.Retweet.Type>
            >("type");
        }
...
#pragma warning restore CS8618
    ...
    [SetsRequiredMembers]
    public NextAction(ApiEnum<string, global::XTwitterScraper.Models.X.Tweets.Retweet.Type> type)
        : this()
    {
        this.Type = type;
    }
...
sealed class TypeConverter : JsonConverter<global::XTwitterScraper.Models.X.Tweets.Retweet.Type>
{
    public override global::XTwitterScraper.Models.X.Tweets.Retweet.Type Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "poll" => global::XTwitterScraper.Models.X.Tweets.Retweet.Type.Poll,
            "retry" => global::XTwitterScraper.Models.X.Tweets.Retweet.Type.Retry,
            "verify_result" => global::XTwitterScraper.Models.X.Tweets.Retweet.Type.VerifyResult,
            "fix_request" => global::XTwitterScraper.Models.X.Tweets.Retweet.Type.FixRequest,
            _ => (global::XTwitterScraper.Models.X.Tweets.Retweet.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::XTwitterScraper.Models.X.Tweets.Retweet.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::XTwitterScraper.Models.X.Tweets.Retweet.Type.Poll => "poll",
                global::XTwitterScraper.Models.X.Tweets.Retweet.Type.Retry => "retry",
                global::XTwitterScraper.Models.X.Tweets.Retweet.Type.VerifyResult =>
                    "verify_result",
                global::XTwitterScraper.Models.X.Tweets.Retweet.Type.FixRequest => "fix_request",
                _ => throw new XTwitterScraperInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
...
[JsonConverter(typeof(RetweetCreateResponseStatusConverter))]
public enum RetweetCreateResponseStatus
{
    Accepted,
    Dispatching,
    PendingConfirmation,
...
sealed class RetweetCreateResponseStatusConverter : JsonConverter<RetweetCreateResponseStatus>
{
    public override RetweetCreateResponseStatus Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "accepted" => RetweetCreateResponseStatus.Accepted,
            "dispatching" => RetweetCreateResponseStatus.Dispatching,
            "pending_confirmation" => RetweetCreateResponseStatus.PendingConfirmation,
            "success" => RetweetCreateResponseStatus.Success,
            "failed" => RetweetCreateResponseStatus.Failed,
            "expired" => RetweetCreateResponseStatus.Expired,
            _ => (RetweetCreateResponseStatus)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        RetweetCreateResponseStatus value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                RetweetCreateResponseStatus.Accepted => "accepted",
                RetweetCreateResponseStatus.Dispatching => "dispatching",
                RetweetCreateResponseStatus.PendingConfirmation => "pending_confirmation",
                RetweetCreateResponseStatus.Success => "success",
                RetweetCreateResponseStatus.Failed => "failed",
                RetweetCreateResponseStatus.Expired => "expired",
                _ => throw new XTwitterScraperInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
