...
/// </summary>
public record class TweetDeleteParams : ParamsBase
{
    ...
    public TweetDeleteParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public TweetDeleteParams(TweetDeleteParams tweetDeleteParams)
        : base(tweetDeleteParams)
    {
        this.TweetID = tweetDeleteParams.TweetID;

        this._rawBodyData = new(tweetDeleteParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static TweetDeleteParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string tweetID
    ...
    public virtual bool Equals(TweetDeleteParams? other)
    {
        if (other == null)
        {
            return false;
