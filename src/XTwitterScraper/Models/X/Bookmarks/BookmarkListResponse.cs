...
/// </summary>
[JsonConverter(typeof(JsonModelConverter<BookmarkListResponse, BookmarkListResponseFromRaw>))]
public sealed record class BookmarkListResponse : JsonModel
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BookmarkListResponse(BookmarkListResponse bookmarkListResponse)
        : base(bookmarkListResponse) { }
#pragma warning restore CS8618

    public BookmarkListResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BookmarkListResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="BookmarkListResponseFromRaw.FromRawUnchecked"/>
    public static BookmarkListResponse FromRawUnchecked(
...
class BookmarkListResponseFromRaw : IFromRawJson<BookmarkListResponse>
{
    /// <inheritdoc/>
    public BookmarkListResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => BookmarkListResponse.FromRawUnchecked(rawData);
}
