...
public record class DraftListParams : ParamsBase
{
    ...
    public string? AfterCursor
    {
        get
        {
            ...
            return this._rawQueryData.GetNullableClass<string>("afterCursor");
        }
        init
        {
            if (value == null)
            ...
            this._rawQueryData.Set("afterCursor", value);
        }
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public DraftListParams(DraftListParams draftListParams)
        : base(draftListParams) { }
