...
public record class TicketCreateParams : ParamsBase
{
    ...
    public required string Subject
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullClass<string>("subject");
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public TicketCreateParams(TicketCreateParams ticketCreateParams)
        : base(ticketCreateParams)
    {
        this._rawBodyData = new(ticketCreateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public virtual bool Equals(TicketCreateParams? other)
    {
        if (other == null)
        {
            return false;
