...
public class CommunityCreateResponseTest : TestBase
{
    ...
    {
        var model = new Communities::CommunityCreateResponse
        {
            ID = "12345",
            Account = new() { ID = "42", Username = "example" },
            Action = Communities::Action.Like,
            Billing = new()
            {
                Charged = true,
                ChargedCredits = "10",
                PlannedCredits = "10",
                Status = Communities::Status.Charged,
            },
            Charged = true,
            ChargedCredits = "10",
            NextAction = new()
            {
                Type = Communities::Type.Poll,
                AfterMs = 2000,
            ...
            Result = new()
            {
                ID = "9876543210",
                State = "liked",
                Type = Communities::ResultType.StateChange,
            },
            Retryable = false,
            SafeToRetry = false,
            SendDispatched = true,
            Status = Communities::CommunityCreateResponseStatus.Success,
            StatusUrl = "/api/v1/x/write-actions/12345",
            Success = true,
            Target = new() { ID = "9876543210", Type = Communities::TargetType.Tweet },
            TargetID = "9876543210",
            Terminal = true,
            WriteActionID = "12345",
        ...
        Communities::CommunityCreateResponseAccount expectedAccount = new()
        {
            ID = "42",
            Username = "example",
        };
        ApiEnum<string, Communities::Action> expectedAction = Communities::Action.Like;
        Communities::Billing expectedBilling = new()
        {
            Charged = true,
            ChargedCredits = "10",
            PlannedCredits = "10",
        ...
        Communities::NextAction expectedNextAction = new()
        {
            Type = Communities::Type.Poll,
            AfterMs = 2000,
            RequiresNewIdempotencyKey = true,
        ...
        Communities::Request expectedRequest = new()
        {
            Hash = "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
            Payload = new Dictionary<string, JsonElement>()
            {
        ...
        Communities::Result expectedResult = new()
        {
            ID = "9876543210",
            State = "liked",
            Type = Communities::ResultType.StateChange,
        ...
        ApiEnum<string, Communities::CommunityCreateResponseStatus> expectedStatus =
            Communities::CommunityCreateResponseStatus.Success;
        string expectedStatusUrl = "/api/v1/x/write-actions/12345";
        bool expectedSuccess = true;
        Communities::Target expectedTarget = new()
        {
            ID = "9876543210",
            Type = Communities::TargetType.Tweet,
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<Communities::CommunityCreateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        Communities::CommunityCreateResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class CommunityCreateResponseAccountTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Communities::CommunityCreateResponseAccount
        {
            ID = "42",
            Username = "example",
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Communities::CommunityCreateResponseAccount>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Communities::CommunityCreateResponseAccount copied = new(model);
...
{
    [Theory]
    [InlineData(Communities::Action.CreateTweet)]
    [InlineData(Communities::Action.DeleteTweet)]
    [InlineData(Communities::Action.Like)]
    [InlineData(Communities::Action.Unlike)]
    [InlineData(Communities::Action.Retweet)]
    [InlineData(Communities::Action.Unretweet)]
    [InlineData(Communities::Action.Follow)]
    [InlineData(Communities::Action.Unfollow)]
    [InlineData(Communities::Action.RemoveFollower)]
    [InlineData(Communities::Action.SendDm)]
    [InlineData(Communities::Action.UploadMedia)]
    [InlineData(Communities::Action.UpdateProfile)]
    [InlineData(Communities::Action.UpdateAvatar)]
    [InlineData(Communities::Action.UpdateBanner)]
    [InlineData(Communities::Action.CreateCommunity)]
    [InlineData(Communities::Action.DeleteCommunity)]
    [InlineData(Communities::Action.JoinCommunity)]
    [InlineData(Communities::Action.LeaveCommunity)]
    public void Validation_Works(Communities::Action rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Communities::Action> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Communities::Action>>(
    ...
    [InlineData(Communities::Action.JoinCommunity)]
    [InlineData(Communities::Action.LeaveCommunity)]
    public void SerializationRoundtrip_Works(Communities::Action rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Communities::Action> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Communities::Action>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class BillingTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new Communities::Billing
        {
            Charged = true,
            ChargedCredits = "10",
            PlannedCredits = "10",
        ...
        ApiEnum<string, Communities::Status> expectedStatus = Communities::Status.Charged;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Communities::Billing>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Communities::Billing copied = new(model);
...
{
    [Theory]
    [InlineData(Communities::Status.NotCharged)]
    [InlineData(Communities::Status.Pending)]
    [InlineData(Communities::Status.Charged)]
    [InlineData(Communities::Status.ChargeFailed)]
    [InlineData(Communities::Status.Refunded)]
    public void Validation_Works(Communities::Status rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Communities::Status> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Communities::Status>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Communities::Status.ChargeFailed)]
    [InlineData(Communities::Status.Refunded)]
    public void SerializationRoundtrip_Works(Communities::Status rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Communities::Status> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Communities::Status>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class NextActionTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new Communities::NextAction
        {
            Type = Communities::Type.Poll,
            AfterMs = 2000,
            RequiresNewIdempotencyKey = true,
        ...
        ApiEnum<string, Communities::Type> expectedType = Communities::Type.Poll;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Communities::NextAction>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void OptionalNonNullablePropertiesUnsetAreNotSet_Works()
    {
        var model = new Communities::NextAction { Type = Communities::Type.Poll };
    ...
    public void CopyConstructor_Works()
    {
        ...
        Communities::NextAction copied = new(model);
...
{
    [Theory]
    [InlineData(Communities::Type.Poll)]
    [InlineData(Communities::Type.Retry)]
    [InlineData(Communities::Type.VerifyResult)]
    [InlineData(Communities::Type.FixRequest)]
    public void Validation_Works(Communities::Type rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Communities::Type> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Communities::Type>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Communities::Type.VerifyResult)]
    [InlineData(Communities::Type.FixRequest)]
    public void SerializationRoundtrip_Works(Communities::Type rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Communities::Type> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Communities::Type>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class RequestTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new Communities::Request
        {
            Hash = "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
            Payload = new Dictionary<string, JsonElement>()
            {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Communities::Request>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Communities::Request copied = new(model);
...
public class ResultTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new Communities::Result
        {
            ID = "9876543210",
            State = "liked",
            Type = Communities::ResultType.StateChange,
        ...
        ApiEnum<string, Communities::ResultType> expectedType = Communities::ResultType.StateChange;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Communities::Result>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Communities::Result copied = new(model);
...
{
    [Theory]
    [InlineData(Communities::ResultType.Tweet)]
    [InlineData(Communities::ResultType.DirectMessage)]
    [InlineData(Communities::ResultType.Media)]
    [InlineData(Communities::ResultType.Community)]
    [InlineData(Communities::ResultType.StateChange)]
    public void Validation_Works(Communities::ResultType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Communities::ResultType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Communities::ResultType>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Communities::ResultType.Community)]
    [InlineData(Communities::ResultType.StateChange)]
    public void SerializationRoundtrip_Works(Communities::ResultType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Communities::ResultType> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Communities::ResultType>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class CommunityCreateResponseStatusTest : TestBase
{
    [Theory]
    [InlineData(Communities::CommunityCreateResponseStatus.Accepted)]
    [InlineData(Communities::CommunityCreateResponseStatus.Dispatching)]
    [InlineData(Communities::CommunityCreateResponseStatus.PendingConfirmation)]
    [InlineData(Communities::CommunityCreateResponseStatus.Success)]
    [InlineData(Communities::CommunityCreateResponseStatus.Failed)]
    [InlineData(Communities::CommunityCreateResponseStatus.Expired)]
    public void Validation_Works(Communities::CommunityCreateResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Communities::CommunityCreateResponseStatus> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<
            ApiEnum<string, Communities::CommunityCreateResponseStatus>
    ...
    [InlineData(Communities::CommunityCreateResponseStatus.Failed)]
    [InlineData(Communities::CommunityCreateResponseStatus.Expired)]
    public void SerializationRoundtrip_Works(Communities::CommunityCreateResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Communities::CommunityCreateResponseStatus> value = rawValue;
...
public class TargetTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new Communities::Target
        {
            ID = "9876543210",
            Type = Communities::TargetType.Tweet,
        };
        ...
        string expectedID = "9876543210";
        ApiEnum<string, Communities::TargetType> expectedType = Communities::TargetType.Tweet;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Communities::Target>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Communities::Target copied = new(model);
...
{
    [Theory]
    [InlineData(Communities::TargetType.Tweet)]
    [InlineData(Communities::TargetType.User)]
    [InlineData(Communities::TargetType.Community)]
    public void Validation_Works(Communities::TargetType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Communities::TargetType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Communities::TargetType>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Communities::TargetType.User)]
    [InlineData(Communities::TargetType.Community)]
    public void SerializationRoundtrip_Works(Communities::TargetType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Communities::TargetType> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Communities::TargetType>>(
            json,
            ModelBase.SerializerOptions
        );
