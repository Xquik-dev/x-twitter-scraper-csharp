...
public class CommunityRetrieveMembersResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CommunityRetrieveMembersResponse
        {
            HasNextPage = true,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<CommunityRetrieveMembersResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        CommunityRetrieveMembersResponse copied = new(model);
