...
public class JoinDeleteAllResponseTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new JoinDeleteAllResponse
        {
            ...
            Action = JoinDeleteAllResponseAction.Like,
            Billing = new()
            {
                Charged = true,
                ChargedCredits = "10",
                PlannedCredits = "10",
                Status = JoinDeleteAllResponseBillingStatus.Charged,
            },
            Charged = true,
            ChargedCredits = "10",
            NextAction = new()
            {
                Type = JoinDeleteAllResponseNextActionType.Poll,
                AfterMs = 2000,
            ...
            Result = new()
            {
                ID = "9876543210",
                State = "liked",
                Type = JoinDeleteAllResponseResultType.StateChange,
            },
            Retryable = false,
            SafeToRetry = false,
            SendDispatched = true,
            Status = JoinDeleteAllResponseStatus.Success,
            StatusUrl = "/api/v1/x/write-actions/12345",
            Success = true,
            Target = new() { ID = "9876543210", Type = JoinDeleteAllResponseTargetType.Tweet },
            TargetID = "9876543210",
            Terminal = true,
            WriteActionID = "12345",
        ...
        JoinDeleteAllResponseAccount expectedAccount = new() { ID = "42", Username = "example" };
        ApiEnum<string, JoinDeleteAllResponseAction> expectedAction =
            JoinDeleteAllResponseAction.Like;
        JoinDeleteAllResponseBilling expectedBilling = new()
        {
            Charged = true,
            ChargedCredits = "10",
            PlannedCredits = "10",
        ...
        JoinDeleteAllResponseNextAction expectedNextAction = new()
        {
            Type = JoinDeleteAllResponseNextActionType.Poll,
            AfterMs = 2000,
            RequiresNewIdempotencyKey = true,
        ...
        JoinDeleteAllResponseRequest expectedRequest = new()
        {
            Hash = "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
            Payload = new Dictionary<string, JsonElement>()
            {
        ...
        JoinDeleteAllResponseResult expectedResult = new()
        {
            ID = "9876543210",
            State = "liked",
            Type = JoinDeleteAllResponseResultType.StateChange,
        ...
        ApiEnum<string, JoinDeleteAllResponseStatus> expectedStatus =
            JoinDeleteAllResponseStatus.Success;
        string expectedStatusUrl = "/api/v1/x/write-actions/12345";
        bool expectedSuccess = true;
        JoinDeleteAllResponseTarget expectedTarget = new()
        {
            ID = "9876543210",
            Type = JoinDeleteAllResponseTargetType.Tweet,
        };
...
public class JoinDeleteAllResponseAccountTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new JoinDeleteAllResponseAccount { ID = "42", Username = "example" };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<JoinDeleteAllResponseAccount>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        JoinDeleteAllResponseAccount copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class JoinDeleteAllResponseActionTest : TestBase
{
    [Theory]
    [InlineData(JoinDeleteAllResponseAction.CreateTweet)]
    [InlineData(JoinDeleteAllResponseAction.DeleteTweet)]
    [InlineData(JoinDeleteAllResponseAction.Like)]
    [InlineData(JoinDeleteAllResponseAction.Unlike)]
    [InlineData(JoinDeleteAllResponseAction.Retweet)]
    [InlineData(JoinDeleteAllResponseAction.Unretweet)]
    [InlineData(JoinDeleteAllResponseAction.Follow)]
    [InlineData(JoinDeleteAllResponseAction.Unfollow)]
    [InlineData(JoinDeleteAllResponseAction.RemoveFollower)]
    [InlineData(JoinDeleteAllResponseAction.SendDm)]
    [InlineData(JoinDeleteAllResponseAction.UploadMedia)]
    [InlineData(JoinDeleteAllResponseAction.UpdateProfile)]
    [InlineData(JoinDeleteAllResponseAction.UpdateAvatar)]
    [InlineData(JoinDeleteAllResponseAction.UpdateBanner)]
    [InlineData(JoinDeleteAllResponseAction.CreateCommunity)]
    [InlineData(JoinDeleteAllResponseAction.DeleteCommunity)]
    [InlineData(JoinDeleteAllResponseAction.JoinCommunity)]
    [InlineData(JoinDeleteAllResponseAction.LeaveCommunity)]
    public void Validation_Works(JoinDeleteAllResponseAction rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, JoinDeleteAllResponseAction> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, JoinDeleteAllResponseAction>>(
    ...
    [InlineData(JoinDeleteAllResponseAction.JoinCommunity)]
    [InlineData(JoinDeleteAllResponseAction.LeaveCommunity)]
    public void SerializationRoundtrip_Works(JoinDeleteAllResponseAction rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, JoinDeleteAllResponseAction> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, JoinDeleteAllResponseAction>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class JoinDeleteAllResponseBillingTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new JoinDeleteAllResponseBilling
        {
            Charged = true,
            ChargedCredits = "10",
            PlannedCredits = "10",
        ...
        ApiEnum<string, JoinDeleteAllResponseBillingStatus> expectedStatus =
            JoinDeleteAllResponseBillingStatus.Charged;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<JoinDeleteAllResponseBilling>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        JoinDeleteAllResponseBilling copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class JoinDeleteAllResponseBillingStatusTest : TestBase
{
    [Theory]
    [InlineData(JoinDeleteAllResponseBillingStatus.NotCharged)]
    [InlineData(JoinDeleteAllResponseBillingStatus.Pending)]
    [InlineData(JoinDeleteAllResponseBillingStatus.Charged)]
    [InlineData(JoinDeleteAllResponseBillingStatus.ChargeFailed)]
    [InlineData(JoinDeleteAllResponseBillingStatus.Refunded)]
    public void Validation_Works(JoinDeleteAllResponseBillingStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, JoinDeleteAllResponseBillingStatus> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, JoinDeleteAllResponseBillingStatus>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(JoinDeleteAllResponseBillingStatus.ChargeFailed)]
    [InlineData(JoinDeleteAllResponseBillingStatus.Refunded)]
    public void SerializationRoundtrip_Works(JoinDeleteAllResponseBillingStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, JoinDeleteAllResponseBillingStatus> value = rawValue;
...
public class JoinDeleteAllResponseNextActionTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new JoinDeleteAllResponseNextAction
        {
            Type = JoinDeleteAllResponseNextActionType.Poll,
            AfterMs = 2000,
            RequiresNewIdempotencyKey = true,
        ...
        ApiEnum<string, JoinDeleteAllResponseNextActionType> expectedType =
            JoinDeleteAllResponseNextActionType.Poll;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<JoinDeleteAllResponseNextAction>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        JoinDeleteAllResponseNextAction copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class JoinDeleteAllResponseNextActionTypeTest : TestBase
{
    [Theory]
    [InlineData(JoinDeleteAllResponseNextActionType.Poll)]
    [InlineData(JoinDeleteAllResponseNextActionType.Retry)]
    [InlineData(JoinDeleteAllResponseNextActionType.VerifyResult)]
    [InlineData(JoinDeleteAllResponseNextActionType.FixRequest)]
    public void Validation_Works(JoinDeleteAllResponseNextActionType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, JoinDeleteAllResponseNextActionType> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(JoinDeleteAllResponseNextActionType.VerifyResult)]
    [InlineData(JoinDeleteAllResponseNextActionType.FixRequest)]
    public void SerializationRoundtrip_Works(JoinDeleteAllResponseNextActionType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, JoinDeleteAllResponseNextActionType> value = rawValue;
...
public class JoinDeleteAllResponseRequestTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new JoinDeleteAllResponseRequest
        {
            Hash = "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
            Payload = new Dictionary<string, JsonElement>()
            {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<JoinDeleteAllResponseRequest>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        JoinDeleteAllResponseRequest copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class JoinDeleteAllResponseResultTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new JoinDeleteAllResponseResult
        {
            ID = "9876543210",
            State = "liked",
            Type = JoinDeleteAllResponseResultType.StateChange,
        ...
        ApiEnum<string, JoinDeleteAllResponseResultType> expectedType =
            JoinDeleteAllResponseResultType.StateChange;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<JoinDeleteAllResponseResult>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        JoinDeleteAllResponseResult copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class JoinDeleteAllResponseResultTypeTest : TestBase
{
    [Theory]
    [InlineData(JoinDeleteAllResponseResultType.Tweet)]
    [InlineData(JoinDeleteAllResponseResultType.DirectMessage)]
    [InlineData(JoinDeleteAllResponseResultType.Media)]
    [InlineData(JoinDeleteAllResponseResultType.Community)]
    [InlineData(JoinDeleteAllResponseResultType.StateChange)]
    public void Validation_Works(JoinDeleteAllResponseResultType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, JoinDeleteAllResponseResultType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, JoinDeleteAllResponseResultType>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(JoinDeleteAllResponseResultType.Community)]
    [InlineData(JoinDeleteAllResponseResultType.StateChange)]
    public void SerializationRoundtrip_Works(JoinDeleteAllResponseResultType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, JoinDeleteAllResponseResultType> value = rawValue;
        ...
        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, JoinDeleteAllResponseResultType>
        >(json, ModelBase.SerializerOptions);
...
public class JoinDeleteAllResponseStatusTest : TestBase
{
    [Theory]
    [InlineData(JoinDeleteAllResponseStatus.Accepted)]
    [InlineData(JoinDeleteAllResponseStatus.Dispatching)]
    [InlineData(JoinDeleteAllResponseStatus.PendingConfirmation)]
    [InlineData(JoinDeleteAllResponseStatus.Success)]
    [InlineData(JoinDeleteAllResponseStatus.Failed)]
    [InlineData(JoinDeleteAllResponseStatus.Expired)]
    public void Validation_Works(JoinDeleteAllResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, JoinDeleteAllResponseStatus> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, JoinDeleteAllResponseStatus>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(JoinDeleteAllResponseStatus.Failed)]
    [InlineData(JoinDeleteAllResponseStatus.Expired)]
    public void SerializationRoundtrip_Works(JoinDeleteAllResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, JoinDeleteAllResponseStatus> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, JoinDeleteAllResponseStatus>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class JoinDeleteAllResponseTargetTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new JoinDeleteAllResponseTarget
        {
            ID = "9876543210",
            Type = JoinDeleteAllResponseTargetType.Tweet,
        };
        ...
        string expectedID = "9876543210";
        ApiEnum<string, JoinDeleteAllResponseTargetType> expectedType =
            JoinDeleteAllResponseTargetType.Tweet;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<JoinDeleteAllResponseTarget>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        JoinDeleteAllResponseTarget copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class JoinDeleteAllResponseTargetTypeTest : TestBase
{
    [Theory]
    [InlineData(JoinDeleteAllResponseTargetType.Tweet)]
    [InlineData(JoinDeleteAllResponseTargetType.User)]
    [InlineData(JoinDeleteAllResponseTargetType.Community)]
    public void Validation_Works(JoinDeleteAllResponseTargetType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, JoinDeleteAllResponseTargetType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, JoinDeleteAllResponseTargetType>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(JoinDeleteAllResponseTargetType.User)]
    [InlineData(JoinDeleteAllResponseTargetType.Community)]
    public void SerializationRoundtrip_Works(JoinDeleteAllResponseTargetType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, JoinDeleteAllResponseTargetType> value = rawValue;
        ...
        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, JoinDeleteAllResponseTargetType>
        >(json, ModelBase.SerializerOptions);
