...
public class JoinCreateResponseTest : TestBase
{
    ...
    {
        var model = new Join::JoinCreateResponse
        {
            ID = "12345",
            Account = new() { ID = "42", Username = "example" },
            Action = Join::Action.Like,
            Billing = new()
            {
                Charged = true,
                ChargedCredits = "10",
                PlannedCredits = "10",
                Status = Join::Status.Charged,
            },
            Charged = true,
            ChargedCredits = "10",
            NextAction = new()
            ...
            Result = new()
            {
                ID = "9876543210",
                State = "liked",
                Type = Join::ResultType.StateChange,
            },
            Retryable = false,
            SafeToRetry = false,
            SendDispatched = true,
            Status = Join::JoinCreateResponseStatus.Success,
            StatusUrl = "/api/v1/x/write-actions/12345",
            Success = true,
            Target = new() { ID = "9876543210", Type = Join::TargetType.Tweet },
            TargetID = "9876543210",
            Terminal = true,
            WriteActionID = "12345",
        ...
        Join::JoinCreateResponseAccount expectedAccount = new() { ID = "42", Username = "example" };
        ApiEnum<string, Join::Action> expectedAction = Join::Action.Like;
        Join::Billing expectedBilling = new()
        {
            Charged = true,
            ChargedCredits = "10",
            PlannedCredits = "10",
        ...
        Join::NextAction expectedNextAction = new()
        {
            Type = Join::Type.Poll,
            AfterMs = 2000,
            RequiresNewIdempotencyKey = true,
        ...
        Join::Request expectedRequest = new()
        {
            Hash = "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
            Payload = new Dictionary<string, JsonElement>()
            {
        ...
        Join::Result expectedResult = new()
        {
            ID = "9876543210",
            State = "liked",
            Type = Join::ResultType.StateChange,
        ...
        ApiEnum<string, Join::JoinCreateResponseStatus> expectedStatus =
            Join::JoinCreateResponseStatus.Success;
        string expectedStatusUrl = "/api/v1/x/write-actions/12345";
        bool expectedSuccess = true;
        Join::Target expectedTarget = new() { ID = "9876543210", Type = Join::TargetType.Tweet };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<Join::JoinCreateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        Join::JoinCreateResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class JoinCreateResponseAccountTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Join::JoinCreateResponseAccount { ID = "42", Username = "example" };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Join::JoinCreateResponseAccount>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Join::JoinCreateResponseAccount copied = new(model);
...
{
    [Theory]
    [InlineData(Join::Action.CreateTweet)]
    [InlineData(Join::Action.DeleteTweet)]
    [InlineData(Join::Action.Like)]
    [InlineData(Join::Action.Unlike)]
    [InlineData(Join::Action.Retweet)]
    [InlineData(Join::Action.Unretweet)]
    [InlineData(Join::Action.Follow)]
    [InlineData(Join::Action.Unfollow)]
    [InlineData(Join::Action.RemoveFollower)]
    [InlineData(Join::Action.SendDm)]
    [InlineData(Join::Action.UploadMedia)]
    [InlineData(Join::Action.UpdateProfile)]
    [InlineData(Join::Action.UpdateAvatar)]
    [InlineData(Join::Action.UpdateBanner)]
    [InlineData(Join::Action.CreateCommunity)]
    [InlineData(Join::Action.DeleteCommunity)]
    [InlineData(Join::Action.JoinCommunity)]
    [InlineData(Join::Action.LeaveCommunity)]
    public void Validation_Works(Join::Action rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Join::Action> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Join::Action>>(
    ...
    [InlineData(Join::Action.JoinCommunity)]
    [InlineData(Join::Action.LeaveCommunity)]
    public void SerializationRoundtrip_Works(Join::Action rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Join::Action> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Join::Action>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class BillingTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        ApiEnum<string, Join::Status> expectedStatus = Join::Status.Charged;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Join::Billing>(
            json,
            ModelBase.SerializerOptions
        );
...
{
    [Theory]
    [InlineData(Join::Status.NotCharged)]
    [InlineData(Join::Status.Pending)]
    [InlineData(Join::Status.Charged)]
    [InlineData(Join::Status.ChargeFailed)]
    [InlineData(Join::Status.Refunded)]
    public void Validation_Works(Join::Status rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Join::Status> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Join::Status>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Join::Status.ChargeFailed)]
    [InlineData(Join::Status.Refunded)]
    public void SerializationRoundtrip_Works(Join::Status rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Join::Status> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Join::Status>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class NextActionTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        ApiEnum<string, Join::Type> expectedType = Join::Type.Poll;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Join::NextAction>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void OptionalNonNullablePropertiesUnsetAreNotSet_Works()
    {
        var model = new Join::NextAction { Type = Join::Type.Poll };
    ...
    public void CopyConstructor_Works()
    {
        ...
        Join::NextAction copied = new(model);
...
{
    [Theory]
    [InlineData(Join::Type.Poll)]
    [InlineData(Join::Type.Retry)]
    [InlineData(Join::Type.VerifyResult)]
    [InlineData(Join::Type.FixRequest)]
    public void Validation_Works(Join::Type rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Join::Type> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Join::Type>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Join::Type.VerifyResult)]
    [InlineData(Join::Type.FixRequest)]
    public void SerializationRoundtrip_Works(Join::Type rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Join::Type> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Join::Type>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class RequestTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Join::Request>(
            json,
            ModelBase.SerializerOptions
        );
...
public class ResultTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        ApiEnum<string, Join::ResultType> expectedType = Join::ResultType.StateChange;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Join::Result>(
            json,
            ModelBase.SerializerOptions
        );
...
{
    [Theory]
    [InlineData(Join::ResultType.Tweet)]
    [InlineData(Join::ResultType.DirectMessage)]
    [InlineData(Join::ResultType.Media)]
    [InlineData(Join::ResultType.Community)]
    [InlineData(Join::ResultType.StateChange)]
    public void Validation_Works(Join::ResultType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Join::ResultType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Join::ResultType>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Join::ResultType.Community)]
    [InlineData(Join::ResultType.StateChange)]
    public void SerializationRoundtrip_Works(Join::ResultType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Join::ResultType> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Join::ResultType>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class JoinCreateResponseStatusTest : TestBase
{
    [Theory]
    [InlineData(Join::JoinCreateResponseStatus.Accepted)]
    [InlineData(Join::JoinCreateResponseStatus.Dispatching)]
    [InlineData(Join::JoinCreateResponseStatus.PendingConfirmation)]
    [InlineData(Join::JoinCreateResponseStatus.Success)]
    [InlineData(Join::JoinCreateResponseStatus.Failed)]
    [InlineData(Join::JoinCreateResponseStatus.Expired)]
    public void Validation_Works(Join::JoinCreateResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Join::JoinCreateResponseStatus> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Join::JoinCreateResponseStatus>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Join::JoinCreateResponseStatus.Failed)]
    [InlineData(Join::JoinCreateResponseStatus.Expired)]
    public void SerializationRoundtrip_Works(Join::JoinCreateResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Join::JoinCreateResponseStatus> value = rawValue;
        ...
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, Join::JoinCreateResponseStatus>
...
public class TargetTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new Join::Target { ID = "9876543210", Type = Join::TargetType.Tweet };

        string expectedID = "9876543210";
        ApiEnum<string, Join::TargetType> expectedType = Join::TargetType.Tweet;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Join::Target>(
            json,
            ModelBase.SerializerOptions
        );
...
{
    [Theory]
    [InlineData(Join::TargetType.Tweet)]
    [InlineData(Join::TargetType.User)]
    [InlineData(Join::TargetType.Community)]
    public void Validation_Works(Join::TargetType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Join::TargetType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Join::TargetType>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Join::TargetType.User)]
    [InlineData(Join::TargetType.Community)]
    public void SerializationRoundtrip_Works(Join::TargetType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Join::TargetType> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Join::TargetType>>(
            json,
            ModelBase.SerializerOptions
        );
