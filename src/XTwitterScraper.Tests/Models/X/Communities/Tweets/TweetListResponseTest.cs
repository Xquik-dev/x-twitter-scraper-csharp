...
public class TweetListResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new TweetListResponse
        {
            HasNextPage = true,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<TweetListResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        TweetListResponse copied = new(model);
