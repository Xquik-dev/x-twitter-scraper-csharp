...
public class CommunityDeleteResponseTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new CommunityDeleteResponse
        {
            ...
            Action = CommunityDeleteResponseAction.Like,
            Billing = new()
            {
                Charged = true,
                ChargedCredits = "10",
                PlannedCredits = "10",
                Status = CommunityDeleteResponseBillingStatus.Charged,
            },
            Charged = true,
            ChargedCredits = "10",
            NextAction = new()
            {
                Type = CommunityDeleteResponseNextActionType.Poll,
                AfterMs = 2000,
            ...
            Result = new()
            {
                ID = "9876543210",
                State = "liked",
                Type = CommunityDeleteResponseResultType.StateChange,
            },
            Retryable = false,
            SafeToRetry = false,
            SendDispatched = true,
            Status = CommunityDeleteResponseStatus.Success,
            StatusUrl = "/api/v1/x/write-actions/12345",
            Success = true,
            Target = new() { ID = "9876543210", Type = CommunityDeleteResponseTargetType.Tweet },
            TargetID = "9876543210",
            Terminal = true,
            WriteActionID = "12345",
        ...
        CommunityDeleteResponseAccount expectedAccount = new() { ID = "42", Username = "example" };
        ApiEnum<string, CommunityDeleteResponseAction> expectedAction =
            CommunityDeleteResponseAction.Like;
        CommunityDeleteResponseBilling expectedBilling = new()
        {
            Charged = true,
            ChargedCredits = "10",
            PlannedCredits = "10",
        ...
        CommunityDeleteResponseNextAction expectedNextAction = new()
        {
            Type = CommunityDeleteResponseNextActionType.Poll,
            AfterMs = 2000,
            RequiresNewIdempotencyKey = true,
        ...
        CommunityDeleteResponseRequest expectedRequest = new()
        {
            Hash = "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
            Payload = new Dictionary<string, JsonElement>()
            {
        ...
        CommunityDeleteResponseResult expectedResult = new()
        {
            ID = "9876543210",
            State = "liked",
            Type = CommunityDeleteResponseResultType.StateChange,
        ...
        ApiEnum<string, CommunityDeleteResponseStatus> expectedStatus =
            CommunityDeleteResponseStatus.Success;
        string expectedStatusUrl = "/api/v1/x/write-actions/12345";
        bool expectedSuccess = true;
        CommunityDeleteResponseTarget expectedTarget = new()
        {
            ID = "9876543210",
            Type = CommunityDeleteResponseTargetType.Tweet,
        };
...
public class CommunityDeleteResponseAccountTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CommunityDeleteResponseAccount { ID = "42", Username = "example" };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<CommunityDeleteResponseAccount>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        CommunityDeleteResponseAccount copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class CommunityDeleteResponseActionTest : TestBase
{
    [Theory]
    [InlineData(CommunityDeleteResponseAction.CreateTweet)]
    [InlineData(CommunityDeleteResponseAction.DeleteTweet)]
    [InlineData(CommunityDeleteResponseAction.Like)]
    [InlineData(CommunityDeleteResponseAction.Unlike)]
    [InlineData(CommunityDeleteResponseAction.Retweet)]
    [InlineData(CommunityDeleteResponseAction.Unretweet)]
    [InlineData(CommunityDeleteResponseAction.Follow)]
    [InlineData(CommunityDeleteResponseAction.Unfollow)]
    [InlineData(CommunityDeleteResponseAction.RemoveFollower)]
    [InlineData(CommunityDeleteResponseAction.SendDm)]
    [InlineData(CommunityDeleteResponseAction.UploadMedia)]
    [InlineData(CommunityDeleteResponseAction.UpdateProfile)]
    [InlineData(CommunityDeleteResponseAction.UpdateAvatar)]
    [InlineData(CommunityDeleteResponseAction.UpdateBanner)]
    [InlineData(CommunityDeleteResponseAction.CreateCommunity)]
    [InlineData(CommunityDeleteResponseAction.DeleteCommunity)]
    [InlineData(CommunityDeleteResponseAction.JoinCommunity)]
    [InlineData(CommunityDeleteResponseAction.LeaveCommunity)]
    public void Validation_Works(CommunityDeleteResponseAction rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, CommunityDeleteResponseAction> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, CommunityDeleteResponseAction>>(
    ...
    [InlineData(CommunityDeleteResponseAction.JoinCommunity)]
    [InlineData(CommunityDeleteResponseAction.LeaveCommunity)]
    public void SerializationRoundtrip_Works(CommunityDeleteResponseAction rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, CommunityDeleteResponseAction> value = rawValue;
        ...
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, CommunityDeleteResponseAction>
...
public class CommunityDeleteResponseBillingTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CommunityDeleteResponseBilling
        {
            Charged = true,
            ChargedCredits = "10",
            PlannedCredits = "10",
        ...
        ApiEnum<string, CommunityDeleteResponseBillingStatus> expectedStatus =
            CommunityDeleteResponseBillingStatus.Charged;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<CommunityDeleteResponseBilling>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        CommunityDeleteResponseBilling copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class CommunityDeleteResponseBillingStatusTest : TestBase
{
    [Theory]
    [InlineData(CommunityDeleteResponseBillingStatus.NotCharged)]
    [InlineData(CommunityDeleteResponseBillingStatus.Pending)]
    [InlineData(CommunityDeleteResponseBillingStatus.Charged)]
    [InlineData(CommunityDeleteResponseBillingStatus.ChargeFailed)]
    [InlineData(CommunityDeleteResponseBillingStatus.Refunded)]
    public void Validation_Works(CommunityDeleteResponseBillingStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, CommunityDeleteResponseBillingStatus> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(CommunityDeleteResponseBillingStatus.ChargeFailed)]
    [InlineData(CommunityDeleteResponseBillingStatus.Refunded)]
    public void SerializationRoundtrip_Works(CommunityDeleteResponseBillingStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, CommunityDeleteResponseBillingStatus> value = rawValue;
...
public class CommunityDeleteResponseNextActionTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CommunityDeleteResponseNextAction
        {
            Type = CommunityDeleteResponseNextActionType.Poll,
            AfterMs = 2000,
            RequiresNewIdempotencyKey = true,
        ...
        ApiEnum<string, CommunityDeleteResponseNextActionType> expectedType =
            CommunityDeleteResponseNextActionType.Poll;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<CommunityDeleteResponseNextAction>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        CommunityDeleteResponseNextAction copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class CommunityDeleteResponseNextActionTypeTest : TestBase
{
    [Theory]
    [InlineData(CommunityDeleteResponseNextActionType.Poll)]
    [InlineData(CommunityDeleteResponseNextActionType.Retry)]
    [InlineData(CommunityDeleteResponseNextActionType.VerifyResult)]
    [InlineData(CommunityDeleteResponseNextActionType.FixRequest)]
    public void Validation_Works(CommunityDeleteResponseNextActionType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, CommunityDeleteResponseNextActionType> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(CommunityDeleteResponseNextActionType.VerifyResult)]
    [InlineData(CommunityDeleteResponseNextActionType.FixRequest)]
    public void SerializationRoundtrip_Works(CommunityDeleteResponseNextActionType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, CommunityDeleteResponseNextActionType> value = rawValue;
...
public class CommunityDeleteResponseRequestTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CommunityDeleteResponseRequest
        {
            Hash = "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
            Payload = new Dictionary<string, JsonElement>()
            {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<CommunityDeleteResponseRequest>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        CommunityDeleteResponseRequest copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class CommunityDeleteResponseResultTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CommunityDeleteResponseResult
        {
            ID = "9876543210",
            State = "liked",
            Type = CommunityDeleteResponseResultType.StateChange,
        ...
        ApiEnum<string, CommunityDeleteResponseResultType> expectedType =
            CommunityDeleteResponseResultType.StateChange;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<CommunityDeleteResponseResult>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        CommunityDeleteResponseResult copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class CommunityDeleteResponseResultTypeTest : TestBase
{
    [Theory]
    [InlineData(CommunityDeleteResponseResultType.Tweet)]
    [InlineData(CommunityDeleteResponseResultType.DirectMessage)]
    [InlineData(CommunityDeleteResponseResultType.Media)]
    [InlineData(CommunityDeleteResponseResultType.Community)]
    [InlineData(CommunityDeleteResponseResultType.StateChange)]
    public void Validation_Works(CommunityDeleteResponseResultType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, CommunityDeleteResponseResultType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, CommunityDeleteResponseResultType>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(CommunityDeleteResponseResultType.Community)]
    [InlineData(CommunityDeleteResponseResultType.StateChange)]
    public void SerializationRoundtrip_Works(CommunityDeleteResponseResultType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, CommunityDeleteResponseResultType> value = rawValue;
...
public class CommunityDeleteResponseStatusTest : TestBase
{
    [Theory]
    [InlineData(CommunityDeleteResponseStatus.Accepted)]
    [InlineData(CommunityDeleteResponseStatus.Dispatching)]
    [InlineData(CommunityDeleteResponseStatus.PendingConfirmation)]
    [InlineData(CommunityDeleteResponseStatus.Success)]
    [InlineData(CommunityDeleteResponseStatus.Failed)]
    [InlineData(CommunityDeleteResponseStatus.Expired)]
    public void Validation_Works(CommunityDeleteResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, CommunityDeleteResponseStatus> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, CommunityDeleteResponseStatus>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(CommunityDeleteResponseStatus.Failed)]
    [InlineData(CommunityDeleteResponseStatus.Expired)]
    public void SerializationRoundtrip_Works(CommunityDeleteResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, CommunityDeleteResponseStatus> value = rawValue;
        ...
        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, CommunityDeleteResponseStatus>
        >(json, ModelBase.SerializerOptions);
...
public class CommunityDeleteResponseTargetTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CommunityDeleteResponseTarget
        {
            ID = "9876543210",
            Type = CommunityDeleteResponseTargetType.Tweet,
        };
        ...
        string expectedID = "9876543210";
        ApiEnum<string, CommunityDeleteResponseTargetType> expectedType =
            CommunityDeleteResponseTargetType.Tweet;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<CommunityDeleteResponseTarget>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        CommunityDeleteResponseTarget copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class CommunityDeleteResponseTargetTypeTest : TestBase
{
    [Theory]
    [InlineData(CommunityDeleteResponseTargetType.Tweet)]
    [InlineData(CommunityDeleteResponseTargetType.User)]
    [InlineData(CommunityDeleteResponseTargetType.Community)]
    public void Validation_Works(CommunityDeleteResponseTargetType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, CommunityDeleteResponseTargetType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, CommunityDeleteResponseTargetType>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(CommunityDeleteResponseTargetType.User)]
    [InlineData(CommunityDeleteResponseTargetType.Community)]
    public void SerializationRoundtrip_Works(CommunityDeleteResponseTargetType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, CommunityDeleteResponseTargetType> value = rawValue;
