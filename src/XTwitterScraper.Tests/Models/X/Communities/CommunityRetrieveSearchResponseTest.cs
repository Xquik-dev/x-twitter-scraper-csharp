...
public class CommunityRetrieveSearchResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CommunityRetrieveSearchResponse
        {
            HasNextPage = true,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<CommunityRetrieveSearchResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        CommunityRetrieveSearchResponse copied = new(model);
