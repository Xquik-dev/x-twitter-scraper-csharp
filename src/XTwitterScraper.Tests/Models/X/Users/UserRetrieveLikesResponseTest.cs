...
public class UserRetrieveLikesResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new UserRetrieveLikesResponse
        {
            HasNextPage = true,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<UserRetrieveLikesResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        UserRetrieveLikesResponse copied = new(model);
