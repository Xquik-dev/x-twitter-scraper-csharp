...
public class UserRetrieveLikesParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new UserRetrieveLikesParams
        {
            ID = "id",
            AnyWords = "anyWords",
            Cashtags = "cashtags",
        ...
        ApiEnum<string, Retweets> expectedRetweets = Retweets.Include;
    ...
    {
        var parameters = new UserRetrieveLikesParams { ID = "id" };
    ...
    {
        UserRetrieveLikesParams parameters = new()
        {
            ID = "id",
            AnyWords = "anyWords",
            Cashtags = "cashtags",
    ...
    public void CopyConstructor_Works()
    {
        ...
        UserRetrieveLikesParams copied = new(parameters);
