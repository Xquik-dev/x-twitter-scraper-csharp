...
public class UserRetrieveMentionsResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new UserRetrieveMentionsResponse
        {
            HasNextPage = true,
        ...
        List<UserRetrieveMentionsResponseTweet> expectedTweets =
        [
            new()
            {
                ID = "1234567890",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<UserRetrieveMentionsResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        UserRetrieveMentionsResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class UserRetrieveMentionsResponseTweetTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new UserRetrieveMentionsResponseTweet
        {
            ID = "1234567890",
            Text = "Just launched our new feature!",
            Author = new()
        ...
        UserRetrieveMentionsResponseTweetAuthor expectedAuthor = new()
        {
            ID = "9876543210",
            Name = "Elon Musk",
            Username = "elonmusk",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<UserRetrieveMentionsResponseTweet>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        UserRetrieveMentionsResponseTweet copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class UserRetrieveMentionsResponseTweetAuthorTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new UserRetrieveMentionsResponseTweetAuthor
        {
            ID = "9876543210",
            Name = "Elon Musk",
            Username = "elonmusk",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<UserRetrieveMentionsResponseTweetAuthor>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        UserRetrieveMentionsResponseTweetAuthor copied = new(model);
