...
public class UserRetrieveVerifiedFollowersResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new UserRetrieveVerifiedFollowersResponse
        {
            HasNextPage = true,
        ...
        List<UserRetrieveVerifiedFollowersResponseUser> expectedUsers =
        [
            new()
            {
                ID = "9876543210",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<UserRetrieveVerifiedFollowersResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        UserRetrieveVerifiedFollowersResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class UserRetrieveVerifiedFollowersResponseUserTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new UserRetrieveVerifiedFollowersResponseUser
        {
            ID = "9876543210",
            Name = "Elon Musk",
            Username = "elonmusk",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<UserRetrieveVerifiedFollowersResponseUser>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        UserRetrieveVerifiedFollowersResponseUser copied = new(model);
