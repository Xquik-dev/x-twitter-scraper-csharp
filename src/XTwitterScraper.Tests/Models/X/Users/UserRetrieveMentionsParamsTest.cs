...
public class UserRetrieveMentionsParamsTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var parameters = new UserRetrieveMentionsParams
        {
            ...
            Language = "language",
            MediaType = UserRetrieveMentionsParamsMediaType.Images,
            ...
            MinRetweets = 0,
            PageSize = 1,
            Quotes = UserRetrieveMentionsParamsQuotes.Include,
            QuotesOfTweetID = "quotesOfTweetId",
            Replies = UserRetrieveMentionsParamsReplies.Include,
            Retweets = UserRetrieveMentionsParamsRetweets.Include,
        ...
        ApiEnum<string, UserRetrieveMentionsParamsMediaType> expectedMediaType =
            UserRetrieveMentionsParamsMediaType.Images;
        ...
        ApiEnum<string, UserRetrieveMentionsParamsQuotes> expectedQuotes =
            UserRetrieveMentionsParamsQuotes.Include;
        string expectedQuotesOfTweetID = "quotesOfTweetId";
        ApiEnum<string, UserRetrieveMentionsParamsReplies> expectedReplies =
            UserRetrieveMentionsParamsReplies.Include;
        ApiEnum<string, UserRetrieveMentionsParamsRetweets> expectedRetweets =
            UserRetrieveMentionsParamsRetweets.Include;
...
public class UserRetrieveMentionsParamsMediaTypeTest : TestBase
{
    [Theory]
    [InlineData(UserRetrieveMentionsParamsMediaType.Images)]
    [InlineData(UserRetrieveMentionsParamsMediaType.Videos)]
    [InlineData(UserRetrieveMentionsParamsMediaType.Gifs)]
    [InlineData(UserRetrieveMentionsParamsMediaType.Media)]
    [InlineData(UserRetrieveMentionsParamsMediaType.Links)]
    [InlineData(UserRetrieveMentionsParamsMediaType.None)]
    public void Validation_Works(UserRetrieveMentionsParamsMediaType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, UserRetrieveMentionsParamsMediaType> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(UserRetrieveMentionsParamsMediaType.Links)]
    [InlineData(UserRetrieveMentionsParamsMediaType.None)]
    public void SerializationRoundtrip_Works(UserRetrieveMentionsParamsMediaType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, UserRetrieveMentionsParamsMediaType> value = rawValue;
...
public class UserRetrieveMentionsParamsQuotesTest : TestBase
{
    [Theory]
    [InlineData(UserRetrieveMentionsParamsQuotes.Include)]
    [InlineData(UserRetrieveMentionsParamsQuotes.Exclude)]
    [InlineData(UserRetrieveMentionsParamsQuotes.Only)]
    public void Validation_Works(UserRetrieveMentionsParamsQuotes rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, UserRetrieveMentionsParamsQuotes> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, UserRetrieveMentionsParamsQuotes>>(
    ...
    [InlineData(UserRetrieveMentionsParamsQuotes.Exclude)]
    [InlineData(UserRetrieveMentionsParamsQuotes.Only)]
    public void SerializationRoundtrip_Works(UserRetrieveMentionsParamsQuotes rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, UserRetrieveMentionsParamsQuotes> value = rawValue;
...
public class UserRetrieveMentionsParamsRepliesTest : TestBase
{
    [Theory]
    [InlineData(UserRetrieveMentionsParamsReplies.Include)]
    [InlineData(UserRetrieveMentionsParamsReplies.Exclude)]
    [InlineData(UserRetrieveMentionsParamsReplies.Only)]
    public void Validation_Works(UserRetrieveMentionsParamsReplies rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, UserRetrieveMentionsParamsReplies> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, UserRetrieveMentionsParamsReplies>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(UserRetrieveMentionsParamsReplies.Exclude)]
    [InlineData(UserRetrieveMentionsParamsReplies.Only)]
    public void SerializationRoundtrip_Works(UserRetrieveMentionsParamsReplies rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, UserRetrieveMentionsParamsReplies> value = rawValue;
...
public class UserRetrieveMentionsParamsRetweetsTest : TestBase
{
    [Theory]
    [InlineData(UserRetrieveMentionsParamsRetweets.Include)]
    [InlineData(UserRetrieveMentionsParamsRetweets.Exclude)]
    [InlineData(UserRetrieveMentionsParamsRetweets.Only)]
    public void Validation_Works(UserRetrieveMentionsParamsRetweets rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, UserRetrieveMentionsParamsRetweets> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, UserRetrieveMentionsParamsRetweets>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(UserRetrieveMentionsParamsRetweets.Exclude)]
    [InlineData(UserRetrieveMentionsParamsRetweets.Only)]
    public void SerializationRoundtrip_Works(UserRetrieveMentionsParamsRetweets rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, UserRetrieveMentionsParamsRetweets> value = rawValue;
