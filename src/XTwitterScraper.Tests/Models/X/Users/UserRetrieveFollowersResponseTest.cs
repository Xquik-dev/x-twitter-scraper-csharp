...
public class UserRetrieveFollowersResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new UserRetrieveFollowersResponse
        {
            HasNextPage = true,
        ...
        List<UserRetrieveFollowersResponseUser> expectedUsers =
        [
            new()
            {
                ID = "9876543210",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<UserRetrieveFollowersResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        UserRetrieveFollowersResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class UserRetrieveFollowersResponseUserTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new UserRetrieveFollowersResponseUser
        {
            ID = "9876543210",
            Name = "Elon Musk",
            Username = "elonmusk",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<UserRetrieveFollowersResponseUser>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        UserRetrieveFollowersResponseUser copied = new(model);
