...
public class UserRetrieveFollowingResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new UserRetrieveFollowingResponse
        {
            HasNextPage = true,
        ...
        List<UserRetrieveFollowingResponseUser> expectedUsers =
        [
            new()
            {
                ID = "9876543210",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<UserRetrieveFollowingResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        UserRetrieveFollowingResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class UserRetrieveFollowingResponseUserTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new UserRetrieveFollowingResponseUser
        {
            ID = "9876543210",
            Name = "Elon Musk",
            Username = "elonmusk",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<UserRetrieveFollowingResponseUser>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        UserRetrieveFollowingResponseUser copied = new(model);
