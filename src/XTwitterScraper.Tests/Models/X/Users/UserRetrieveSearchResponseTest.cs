...
public class UserRetrieveSearchResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new UserRetrieveSearchResponse
        {
            HasNextPage = true,
        ...
        List<UserRetrieveSearchResponseUser> expectedUsers =
        [
            new()
            {
                ID = "9876543210",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<UserRetrieveSearchResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        UserRetrieveSearchResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class UserRetrieveSearchResponseUserTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new UserRetrieveSearchResponseUser
        {
            ID = "9876543210",
            Name = "Elon Musk",
            Username = "elonmusk",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<UserRetrieveSearchResponseUser>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        UserRetrieveSearchResponseUser copied = new(model);
