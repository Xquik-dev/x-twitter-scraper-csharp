...
public class UserRetrieveTweetsParamsTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var parameters = new UserRetrieveTweetsParams
        {
            ...
            Language = "language",
            MediaType = UserRetrieveTweetsParamsMediaType.Images,
            ...
            MinRetweets = 0,
            PageSize = 1,
            Quotes = UserRetrieveTweetsParamsQuotes.Include,
            QuotesOfTweetID = "quotesOfTweetId",
            Replies = UserRetrieveTweetsParamsReplies.Include,
            Retweets = UserRetrieveTweetsParamsRetweets.Include,
        ...
        ApiEnum<string, UserRetrieveTweetsParamsMediaType> expectedMediaType =
            UserRetrieveTweetsParamsMediaType.Images;
        ...
        ApiEnum<string, UserRetrieveTweetsParamsQuotes> expectedQuotes =
            UserRetrieveTweetsParamsQuotes.Include;
        string expectedQuotesOfTweetID = "quotesOfTweetId";
        ApiEnum<string, UserRetrieveTweetsParamsReplies> expectedReplies =
            UserRetrieveTweetsParamsReplies.Include;
        ApiEnum<string, UserRetrieveTweetsParamsRetweets> expectedRetweets =
            UserRetrieveTweetsParamsRetweets.Include;
...
public class UserRetrieveTweetsParamsMediaTypeTest : TestBase
{
    [Theory]
    [InlineData(UserRetrieveTweetsParamsMediaType.Images)]
    [InlineData(UserRetrieveTweetsParamsMediaType.Videos)]
    [InlineData(UserRetrieveTweetsParamsMediaType.Gifs)]
    [InlineData(UserRetrieveTweetsParamsMediaType.Media)]
    [InlineData(UserRetrieveTweetsParamsMediaType.Links)]
    [InlineData(UserRetrieveTweetsParamsMediaType.None)]
    public void Validation_Works(UserRetrieveTweetsParamsMediaType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, UserRetrieveTweetsParamsMediaType> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, UserRetrieveTweetsParamsMediaType>>(
    ...
    [InlineData(UserRetrieveTweetsParamsMediaType.Links)]
    [InlineData(UserRetrieveTweetsParamsMediaType.None)]
    public void SerializationRoundtrip_Works(UserRetrieveTweetsParamsMediaType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, UserRetrieveTweetsParamsMediaType> value = rawValue;
...
public class UserRetrieveTweetsParamsQuotesTest : TestBase
{
    [Theory]
    [InlineData(UserRetrieveTweetsParamsQuotes.Include)]
    [InlineData(UserRetrieveTweetsParamsQuotes.Exclude)]
    [InlineData(UserRetrieveTweetsParamsQuotes.Only)]
    public void Validation_Works(UserRetrieveTweetsParamsQuotes rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, UserRetrieveTweetsParamsQuotes> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, UserRetrieveTweetsParamsQuotes>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(UserRetrieveTweetsParamsQuotes.Exclude)]
    [InlineData(UserRetrieveTweetsParamsQuotes.Only)]
    public void SerializationRoundtrip_Works(UserRetrieveTweetsParamsQuotes rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, UserRetrieveTweetsParamsQuotes> value = rawValue;
...
public class UserRetrieveTweetsParamsRepliesTest : TestBase
{
    [Theory]
    [InlineData(UserRetrieveTweetsParamsReplies.Include)]
    [InlineData(UserRetrieveTweetsParamsReplies.Exclude)]
    [InlineData(UserRetrieveTweetsParamsReplies.Only)]
    public void Validation_Works(UserRetrieveTweetsParamsReplies rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, UserRetrieveTweetsParamsReplies> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, UserRetrieveTweetsParamsReplies>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(UserRetrieveTweetsParamsReplies.Exclude)]
    [InlineData(UserRetrieveTweetsParamsReplies.Only)]
    public void SerializationRoundtrip_Works(UserRetrieveTweetsParamsReplies rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, UserRetrieveTweetsParamsReplies> value = rawValue;
...
public class UserRetrieveTweetsParamsRetweetsTest : TestBase
{
    [Theory]
    [InlineData(UserRetrieveTweetsParamsRetweets.Include)]
    [InlineData(UserRetrieveTweetsParamsRetweets.Exclude)]
    [InlineData(UserRetrieveTweetsParamsRetweets.Only)]
    public void Validation_Works(UserRetrieveTweetsParamsRetweets rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, UserRetrieveTweetsParamsRetweets> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, UserRetrieveTweetsParamsRetweets>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(UserRetrieveTweetsParamsRetweets.Exclude)]
    [InlineData(UserRetrieveTweetsParamsRetweets.Only)]
    public void SerializationRoundtrip_Works(UserRetrieveTweetsParamsRetweets rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, UserRetrieveTweetsParamsRetweets> value = rawValue;
