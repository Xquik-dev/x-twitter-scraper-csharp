...
public class FollowDeleteAllResponseTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new FollowDeleteAllResponse
        {
            ...
            Action = FollowDeleteAllResponseAction.Like,
            Billing = new()
            {
                Charged = true,
                ChargedCredits = "10",
                PlannedCredits = "10",
                Status = FollowDeleteAllResponseBillingStatus.Charged,
            },
            Charged = true,
            ChargedCredits = "10",
            NextAction = new()
            {
                Type = FollowDeleteAllResponseNextActionType.Poll,
                AfterMs = 2000,
            ...
            Result = new()
            {
                ID = "9876543210",
                State = "liked",
                Type = FollowDeleteAllResponseResultType.StateChange,
            },
            Retryable = false,
            SafeToRetry = false,
            SendDispatched = true,
            Status = FollowDeleteAllResponseStatus.Success,
            StatusUrl = "/api/v1/x/write-actions/12345",
            Success = true,
            Target = new() { ID = "9876543210", Type = FollowDeleteAllResponseTargetType.Tweet },
            TargetID = "9876543210",
            Terminal = true,
            WriteActionID = "12345",
        ...
        FollowDeleteAllResponseAccount expectedAccount = new() { ID = "42", Username = "example" };
        ApiEnum<string, FollowDeleteAllResponseAction> expectedAction =
            FollowDeleteAllResponseAction.Like;
        FollowDeleteAllResponseBilling expectedBilling = new()
        {
            Charged = true,
            ChargedCredits = "10",
            PlannedCredits = "10",
        ...
        FollowDeleteAllResponseNextAction expectedNextAction = new()
        {
            Type = FollowDeleteAllResponseNextActionType.Poll,
            AfterMs = 2000,
            RequiresNewIdempotencyKey = true,
        ...
        FollowDeleteAllResponseRequest expectedRequest = new()
        {
            Hash = "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
            Payload = new Dictionary<string, JsonElement>()
            {
        ...
        FollowDeleteAllResponseResult expectedResult = new()
        {
            ID = "9876543210",
            State = "liked",
            Type = FollowDeleteAllResponseResultType.StateChange,
        ...
        ApiEnum<string, FollowDeleteAllResponseStatus> expectedStatus =
            FollowDeleteAllResponseStatus.Success;
        string expectedStatusUrl = "/api/v1/x/write-actions/12345";
        bool expectedSuccess = true;
        FollowDeleteAllResponseTarget expectedTarget = new()
        {
            ID = "9876543210",
            Type = FollowDeleteAllResponseTargetType.Tweet,
        };
...
public class FollowDeleteAllResponseAccountTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new FollowDeleteAllResponseAccount { ID = "42", Username = "example" };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<FollowDeleteAllResponseAccount>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        FollowDeleteAllResponseAccount copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class FollowDeleteAllResponseActionTest : TestBase
{
    [Theory]
    [InlineData(FollowDeleteAllResponseAction.CreateTweet)]
    [InlineData(FollowDeleteAllResponseAction.DeleteTweet)]
    [InlineData(FollowDeleteAllResponseAction.Like)]
    [InlineData(FollowDeleteAllResponseAction.Unlike)]
    [InlineData(FollowDeleteAllResponseAction.Retweet)]
    [InlineData(FollowDeleteAllResponseAction.Unretweet)]
    [InlineData(FollowDeleteAllResponseAction.Follow)]
    [InlineData(FollowDeleteAllResponseAction.Unfollow)]
    [InlineData(FollowDeleteAllResponseAction.RemoveFollower)]
    [InlineData(FollowDeleteAllResponseAction.SendDm)]
    [InlineData(FollowDeleteAllResponseAction.UploadMedia)]
    [InlineData(FollowDeleteAllResponseAction.UpdateProfile)]
    [InlineData(FollowDeleteAllResponseAction.UpdateAvatar)]
    [InlineData(FollowDeleteAllResponseAction.UpdateBanner)]
    [InlineData(FollowDeleteAllResponseAction.CreateCommunity)]
    [InlineData(FollowDeleteAllResponseAction.DeleteCommunity)]
    [InlineData(FollowDeleteAllResponseAction.JoinCommunity)]
    [InlineData(FollowDeleteAllResponseAction.LeaveCommunity)]
    public void Validation_Works(FollowDeleteAllResponseAction rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, FollowDeleteAllResponseAction> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, FollowDeleteAllResponseAction>>(
    ...
    [InlineData(FollowDeleteAllResponseAction.JoinCommunity)]
    [InlineData(FollowDeleteAllResponseAction.LeaveCommunity)]
    public void SerializationRoundtrip_Works(FollowDeleteAllResponseAction rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, FollowDeleteAllResponseAction> value = rawValue;
        ...
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, FollowDeleteAllResponseAction>
...
public class FollowDeleteAllResponseBillingTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new FollowDeleteAllResponseBilling
        {
            Charged = true,
            ChargedCredits = "10",
            PlannedCredits = "10",
        ...
        ApiEnum<string, FollowDeleteAllResponseBillingStatus> expectedStatus =
            FollowDeleteAllResponseBillingStatus.Charged;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<FollowDeleteAllResponseBilling>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        FollowDeleteAllResponseBilling copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class FollowDeleteAllResponseBillingStatusTest : TestBase
{
    [Theory]
    [InlineData(FollowDeleteAllResponseBillingStatus.NotCharged)]
    [InlineData(FollowDeleteAllResponseBillingStatus.Pending)]
    [InlineData(FollowDeleteAllResponseBillingStatus.Charged)]
    [InlineData(FollowDeleteAllResponseBillingStatus.ChargeFailed)]
    [InlineData(FollowDeleteAllResponseBillingStatus.Refunded)]
    public void Validation_Works(FollowDeleteAllResponseBillingStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, FollowDeleteAllResponseBillingStatus> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(FollowDeleteAllResponseBillingStatus.ChargeFailed)]
    [InlineData(FollowDeleteAllResponseBillingStatus.Refunded)]
    public void SerializationRoundtrip_Works(FollowDeleteAllResponseBillingStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, FollowDeleteAllResponseBillingStatus> value = rawValue;
...
public class FollowDeleteAllResponseNextActionTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new FollowDeleteAllResponseNextAction
        {
            Type = FollowDeleteAllResponseNextActionType.Poll,
            AfterMs = 2000,
            RequiresNewIdempotencyKey = true,
        ...
        ApiEnum<string, FollowDeleteAllResponseNextActionType> expectedType =
            FollowDeleteAllResponseNextActionType.Poll;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<FollowDeleteAllResponseNextAction>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        FollowDeleteAllResponseNextAction copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class FollowDeleteAllResponseNextActionTypeTest : TestBase
{
    [Theory]
    [InlineData(FollowDeleteAllResponseNextActionType.Poll)]
    [InlineData(FollowDeleteAllResponseNextActionType.Retry)]
    [InlineData(FollowDeleteAllResponseNextActionType.VerifyResult)]
    [InlineData(FollowDeleteAllResponseNextActionType.FixRequest)]
    public void Validation_Works(FollowDeleteAllResponseNextActionType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, FollowDeleteAllResponseNextActionType> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(FollowDeleteAllResponseNextActionType.VerifyResult)]
    [InlineData(FollowDeleteAllResponseNextActionType.FixRequest)]
    public void SerializationRoundtrip_Works(FollowDeleteAllResponseNextActionType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, FollowDeleteAllResponseNextActionType> value = rawValue;
...
public class FollowDeleteAllResponseRequestTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new FollowDeleteAllResponseRequest
        {
            Hash = "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
            Payload = new Dictionary<string, JsonElement>()
            {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<FollowDeleteAllResponseRequest>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        FollowDeleteAllResponseRequest copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class FollowDeleteAllResponseResultTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new FollowDeleteAllResponseResult
        {
            ID = "9876543210",
            State = "liked",
            Type = FollowDeleteAllResponseResultType.StateChange,
        ...
        ApiEnum<string, FollowDeleteAllResponseResultType> expectedType =
            FollowDeleteAllResponseResultType.StateChange;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<FollowDeleteAllResponseResult>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        FollowDeleteAllResponseResult copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class FollowDeleteAllResponseResultTypeTest : TestBase
{
    [Theory]
    [InlineData(FollowDeleteAllResponseResultType.Tweet)]
    [InlineData(FollowDeleteAllResponseResultType.DirectMessage)]
    [InlineData(FollowDeleteAllResponseResultType.Media)]
    [InlineData(FollowDeleteAllResponseResultType.Community)]
    [InlineData(FollowDeleteAllResponseResultType.StateChange)]
    public void Validation_Works(FollowDeleteAllResponseResultType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, FollowDeleteAllResponseResultType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, FollowDeleteAllResponseResultType>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(FollowDeleteAllResponseResultType.Community)]
    [InlineData(FollowDeleteAllResponseResultType.StateChange)]
    public void SerializationRoundtrip_Works(FollowDeleteAllResponseResultType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, FollowDeleteAllResponseResultType> value = rawValue;
...
public class FollowDeleteAllResponseStatusTest : TestBase
{
    [Theory]
    [InlineData(FollowDeleteAllResponseStatus.Accepted)]
    [InlineData(FollowDeleteAllResponseStatus.Dispatching)]
    [InlineData(FollowDeleteAllResponseStatus.PendingConfirmation)]
    [InlineData(FollowDeleteAllResponseStatus.Success)]
    [InlineData(FollowDeleteAllResponseStatus.Failed)]
    [InlineData(FollowDeleteAllResponseStatus.Expired)]
    public void Validation_Works(FollowDeleteAllResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, FollowDeleteAllResponseStatus> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, FollowDeleteAllResponseStatus>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(FollowDeleteAllResponseStatus.Failed)]
    [InlineData(FollowDeleteAllResponseStatus.Expired)]
    public void SerializationRoundtrip_Works(FollowDeleteAllResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, FollowDeleteAllResponseStatus> value = rawValue;
        ...
        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, FollowDeleteAllResponseStatus>
        >(json, ModelBase.SerializerOptions);
...
public class FollowDeleteAllResponseTargetTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new FollowDeleteAllResponseTarget
        {
            ID = "9876543210",
            Type = FollowDeleteAllResponseTargetType.Tweet,
        };
        ...
        string expectedID = "9876543210";
        ApiEnum<string, FollowDeleteAllResponseTargetType> expectedType =
            FollowDeleteAllResponseTargetType.Tweet;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<FollowDeleteAllResponseTarget>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        FollowDeleteAllResponseTarget copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class FollowDeleteAllResponseTargetTypeTest : TestBase
{
    [Theory]
    [InlineData(FollowDeleteAllResponseTargetType.Tweet)]
    [InlineData(FollowDeleteAllResponseTargetType.User)]
    [InlineData(FollowDeleteAllResponseTargetType.Community)]
    public void Validation_Works(FollowDeleteAllResponseTargetType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, FollowDeleteAllResponseTargetType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, FollowDeleteAllResponseTargetType>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(FollowDeleteAllResponseTargetType.User)]
    [InlineData(FollowDeleteAllResponseTargetType.Community)]
    public void SerializationRoundtrip_Works(FollowDeleteAllResponseTargetType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, FollowDeleteAllResponseTargetType> value = rawValue;
