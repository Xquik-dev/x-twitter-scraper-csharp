...
public class FollowCreateParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new FollowCreateParams { UserID = "userId", Account = "account" };
    ...
    {
        FollowCreateParams parameters = new() { UserID = "userId", Account = "account" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        FollowCreateParams copied = new(parameters);
