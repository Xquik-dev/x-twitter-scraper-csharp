...
public class UserRetrieveTweetsResponseTest : TestBase
{
    [Fact]
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<UserRetrieveTweetsResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        UserRetrieveTweetsResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class UserRetrieveTweetsResponseTweetTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<UserRetrieveTweetsResponseTweet>(
            json,
            ModelBase.SerializerOptions
        );
...
public class UserRetrieveTweetsResponseTweetAuthorTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<UserRetrieveTweetsResponseTweetAuthor>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        UserRetrieveTweetsResponseTweetAuthor copied = new(model);
