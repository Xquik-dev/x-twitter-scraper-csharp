...
public class BookmarkListResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BookmarkListResponse
        {
            HasNextPage = true,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BookmarkListResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BookmarkListResponse copied = new(model);
