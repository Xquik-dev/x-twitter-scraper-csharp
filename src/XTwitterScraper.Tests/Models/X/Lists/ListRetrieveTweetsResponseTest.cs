...
public class ListRetrieveTweetsResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ListRetrieveTweetsResponse
        {
            HasNextPage = true,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ListRetrieveTweetsResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ListRetrieveTweetsResponse copied = new(model);
