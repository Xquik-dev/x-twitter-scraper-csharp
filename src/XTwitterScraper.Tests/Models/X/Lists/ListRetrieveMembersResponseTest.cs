...
public class ListRetrieveMembersResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ListRetrieveMembersResponse
        {
            HasNextPage = true,
        ...
        List<ListRetrieveMembersResponseUser> expectedUsers =
        [
            new()
            {
                ID = "9876543210",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ListRetrieveMembersResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ListRetrieveMembersResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ListRetrieveMembersResponseUserTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ListRetrieveMembersResponseUser
        {
            ID = "9876543210",
            Name = "Elon Musk",
            Username = "elonmusk",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ListRetrieveMembersResponseUser>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ListRetrieveMembersResponseUser copied = new(model);
