...
public class ListRetrieveFollowersResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ListRetrieveFollowersResponse
        {
            HasNextPage = true,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ListRetrieveFollowersResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ListRetrieveFollowersResponse copied = new(model);
