...
public class MediaUploadResponseTest : TestBase
{
    ...
    {
        var model = new Media::MediaUploadResponse
        {
            ID = "12345",
            Account = new() { ID = "42", Username = "example" },
            Action = Media::Action.Like,
            Billing = new()
            {
                Charged = true,
                ChargedCredits = "10",
                PlannedCredits = "10",
                Status = Media::Status.Charged,
            },
            Charged = true,
            ChargedCredits = "10",
            NextAction = new()
            {
                Type = Media::Type.Poll,
                AfterMs = 2000,
            ...
            Result = new()
            {
                ID = "9876543210",
                State = "liked",
                Type = Media::ResultType.StateChange,
            },
            Retryable = false,
            SafeToRetry = false,
            SendDispatched = true,
            Status = Media::MediaUploadResponseStatus.Success,
            StatusUrl = "/api/v1/x/write-actions/12345",
            Success = true,
            Target = new() { ID = "9876543210", Type = Media::TargetType.Tweet },
            TargetID = "9876543210",
            Terminal = true,
            WriteActionID = "12345",
        ...
        Media::MediaUploadResponseAccount expectedAccount = new()
        {
            ID = "42",
            Username = "example",
        };
        ApiEnum<string, Media::Action> expectedAction = Media::Action.Like;
        Media::Billing expectedBilling = new()
        {
            Charged = true,
            ChargedCredits = "10",
            PlannedCredits = "10",
        ...
        Media::NextAction expectedNextAction = new()
        {
            Type = Media::Type.Poll,
            AfterMs = 2000,
            RequiresNewIdempotencyKey = true,
        ...
        Media::Request expectedRequest = new()
        {
            Hash = "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
            Payload = new Dictionary<string, JsonElement>()
            {
        ...
        Media::Result expectedResult = new()
        {
            ID = "9876543210",
            State = "liked",
            Type = Media::ResultType.StateChange,
        ...
        ApiEnum<string, Media::MediaUploadResponseStatus> expectedStatus =
            Media::MediaUploadResponseStatus.Success;
        string expectedStatusUrl = "/api/v1/x/write-actions/12345";
        bool expectedSuccess = true;
        Media::Target expectedTarget = new() { ID = "9876543210", Type = Media::TargetType.Tweet };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<Media::MediaUploadResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        Media::MediaUploadResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class MediaUploadResponseAccountTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Media::MediaUploadResponseAccount { ID = "42", Username = "example" };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Media::MediaUploadResponseAccount>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Media::MediaUploadResponseAccount copied = new(model);
...
{
    [Theory]
    [InlineData(Media::Action.CreateTweet)]
    [InlineData(Media::Action.DeleteTweet)]
    [InlineData(Media::Action.Like)]
    [InlineData(Media::Action.Unlike)]
    [InlineData(Media::Action.Retweet)]
    [InlineData(Media::Action.Unretweet)]
    [InlineData(Media::Action.Follow)]
    [InlineData(Media::Action.Unfollow)]
    [InlineData(Media::Action.RemoveFollower)]
    [InlineData(Media::Action.SendDm)]
    [InlineData(Media::Action.UploadMedia)]
    [InlineData(Media::Action.UpdateProfile)]
    [InlineData(Media::Action.UpdateAvatar)]
    [InlineData(Media::Action.UpdateBanner)]
    [InlineData(Media::Action.CreateCommunity)]
    [InlineData(Media::Action.DeleteCommunity)]
    [InlineData(Media::Action.JoinCommunity)]
    [InlineData(Media::Action.LeaveCommunity)]
    public void Validation_Works(Media::Action rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Media::Action> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Media::Action>>(
    ...
    [InlineData(Media::Action.JoinCommunity)]
    [InlineData(Media::Action.LeaveCommunity)]
    public void SerializationRoundtrip_Works(Media::Action rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Media::Action> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Media::Action>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class BillingTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        ApiEnum<string, Media::Status> expectedStatus = Media::Status.Charged;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Media::Billing>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Media::Billing copied = new(model);
...
{
    [Theory]
    [InlineData(Media::Status.NotCharged)]
    [InlineData(Media::Status.Pending)]
    [InlineData(Media::Status.Charged)]
    [InlineData(Media::Status.ChargeFailed)]
    [InlineData(Media::Status.Refunded)]
    public void Validation_Works(Media::Status rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Media::Status> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Media::Status>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Media::Status.ChargeFailed)]
    [InlineData(Media::Status.Refunded)]
    public void SerializationRoundtrip_Works(Media::Status rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Media::Status> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Media::Status>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class NextActionTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new Media::NextAction
        {
            Type = Media::Type.Poll,
            AfterMs = 2000,
            RequiresNewIdempotencyKey = true,
        ...
        ApiEnum<string, Media::Type> expectedType = Media::Type.Poll;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Media::NextAction>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void OptionalNonNullablePropertiesUnsetAreNotSet_Works()
    {
        var model = new Media::NextAction { Type = Media::Type.Poll };
    ...
    public void CopyConstructor_Works()
    {
        ...
        Media::NextAction copied = new(model);
...
{
    [Theory]
    [InlineData(Media::Type.Poll)]
    [InlineData(Media::Type.Retry)]
    [InlineData(Media::Type.VerifyResult)]
    [InlineData(Media::Type.FixRequest)]
    public void Validation_Works(Media::Type rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Media::Type> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Media::Type>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Media::Type.VerifyResult)]
    [InlineData(Media::Type.FixRequest)]
    public void SerializationRoundtrip_Works(Media::Type rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Media::Type> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Media::Type>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class RequestTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Media::Request>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Media::Request copied = new(model);
...
public class ResultTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        ApiEnum<string, Media::ResultType> expectedType = Media::ResultType.StateChange;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Media::Result>(
            json,
            ModelBase.SerializerOptions
        );
...
{
    [Theory]
    [InlineData(Media::ResultType.Tweet)]
    [InlineData(Media::ResultType.DirectMessage)]
    [InlineData(Media::ResultType.Media)]
    [InlineData(Media::ResultType.Community)]
    [InlineData(Media::ResultType.StateChange)]
    public void Validation_Works(Media::ResultType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Media::ResultType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Media::ResultType>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Media::ResultType.Community)]
    [InlineData(Media::ResultType.StateChange)]
    public void SerializationRoundtrip_Works(Media::ResultType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Media::ResultType> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Media::ResultType>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class MediaUploadResponseStatusTest : TestBase
{
    [Theory]
    [InlineData(Media::MediaUploadResponseStatus.Accepted)]
    [InlineData(Media::MediaUploadResponseStatus.Dispatching)]
    [InlineData(Media::MediaUploadResponseStatus.PendingConfirmation)]
    [InlineData(Media::MediaUploadResponseStatus.Success)]
    [InlineData(Media::MediaUploadResponseStatus.Failed)]
    [InlineData(Media::MediaUploadResponseStatus.Expired)]
    public void Validation_Works(Media::MediaUploadResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Media::MediaUploadResponseStatus> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Media::MediaUploadResponseStatus>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Media::MediaUploadResponseStatus.Failed)]
    [InlineData(Media::MediaUploadResponseStatus.Expired)]
    public void SerializationRoundtrip_Works(Media::MediaUploadResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Media::MediaUploadResponseStatus> value = rawValue;
        ...
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, Media::MediaUploadResponseStatus>
...
public class TargetTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new Media::Target { ID = "9876543210", Type = Media::TargetType.Tweet };

        string expectedID = "9876543210";
        ApiEnum<string, Media::TargetType> expectedType = Media::TargetType.Tweet;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Media::Target>(
            json,
            ModelBase.SerializerOptions
        );
...
{
    [Theory]
    [InlineData(Media::TargetType.Tweet)]
    [InlineData(Media::TargetType.User)]
    [InlineData(Media::TargetType.Community)]
    public void Validation_Works(Media::TargetType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Media::TargetType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Media::TargetType>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Media::TargetType.User)]
    [InlineData(Media::TargetType.Community)]
    public void SerializationRoundtrip_Works(Media::TargetType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Media::TargetType> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Media::TargetType>>(
            json,
            ModelBase.SerializerOptions
        );
