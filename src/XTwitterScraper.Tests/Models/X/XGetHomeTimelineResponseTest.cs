...
public class XGetHomeTimelineResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new XGetHomeTimelineResponse
        {
            HasNextPage = true,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<XGetHomeTimelineResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        XGetHomeTimelineResponse copied = new(model);
