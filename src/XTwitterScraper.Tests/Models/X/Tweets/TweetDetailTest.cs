...
using Models = XTwitterScraper.Models;
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new TweetDetail
        {
            ...
            [
                ...
                {
                    MediaUrl = "mediaUrl",
                    Type = Models::TweetMediaType.Photo,
                    Url = "url",
                    ID = "id",
                    AllowDownload = true,
                    AltText = "altText",
                    ...
                    FaceRects = new Dictionary<
                        string,
                        IReadOnlyList<Models::UnnamedSchemaWithArrayParent0>
                    >()
                    {
                        {
                            "foo",
                    ...
                    MediaKey = "mediaKey",
                    Monetizable = true,
                    Sizes = new Dictionary<string, Models::SizesItem>()
                    {
                        {
                            "foo",
                            new()
        ...
        List<Models::TweetMedia> expectedMedia =
        [
            new()
            {
                MediaUrl = "mediaUrl",
