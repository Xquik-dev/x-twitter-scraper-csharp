...
public class TweetSearchResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new TweetSearchResponse
        {
            HasNextPage = true,
        ...
        List<TweetSearchResponseTweet> expectedTweets =
        [
            new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<TweetSearchResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        TweetSearchResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class TweetSearchResponseTweetTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new TweetSearchResponseTweet
        {
            ID = "id",
            Text = "text",
            Author = new()
        ...
        TweetSearchResponseTweetAuthor expectedAuthor = new()
        {
            ID = "id",
            Name = "name",
            Username = "username",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<TweetSearchResponseTweet>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    {
        var model = new TweetSearchResponseTweet { ID = "id", Text = "text" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        TweetSearchResponseTweet copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class TweetSearchResponseTweetAuthorTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new TweetSearchResponseTweetAuthor
        {
            ID = "id",
            Name = "name",
            Username = "username",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<TweetSearchResponseTweetAuthor>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        TweetSearchResponseTweetAuthor copied = new(model);
