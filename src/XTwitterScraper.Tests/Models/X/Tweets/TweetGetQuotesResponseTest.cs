...
public class TweetGetQuotesResponseTest : TestBase
{
    [Fact]
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<TweetGetQuotesResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        TweetGetQuotesResponse copied = new(model);
