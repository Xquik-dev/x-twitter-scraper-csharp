...
public class LikeCreateResponseTest : TestBase
{
    ...
    {
        var model = new Like::LikeCreateResponse
        {
            ID = "12345",
            ...
            Result = new()
            {
                ID = "9876543210",
                State = "liked",
                Type = Like::ResultType.StateChange,
            },
            Retryable = false,
            SafeToRetry = false,
            SendDispatched = true,
            Status = Like::LikeCreateResponseStatus.Success,
            StatusUrl = "/api/v1/x/write-actions/12345",
            Success = true,
            Target = new() { ID = "9876543210", Type = Like::TargetType.Tweet },
            TargetID = "9876543210",
            Terminal = true,
            WriteActionID = "12345",
        ...
        Like::LikeCreateResponseAccount expectedAccount = new() { ID = "42", Username = "example" };
        ApiEnum<string, Like::Action> expectedAction = Like::Action.Like;
        Like::Billing expectedBilling = new()
        {
            Charged = true,
            ChargedCredits = "10",
            PlannedCredits = "10",
        ...
        Like::NextAction expectedNextAction = new()
        {
            Type = Like::Type.Poll,
            AfterMs = 2000,
            RequiresNewIdempotencyKey = true,
        ...
        Like::Request expectedRequest = new()
        {
            Hash = "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
            Payload = new Dictionary<string, JsonElement>()
            {
        ...
        Like::Result expectedResult = new()
        {
            ID = "9876543210",
            State = "liked",
            Type = Like::ResultType.StateChange,
        ...
        ApiEnum<string, Like::LikeCreateResponseStatus> expectedStatus =
            Like::LikeCreateResponseStatus.Success;
        string expectedStatusUrl = "/api/v1/x/write-actions/12345";
        bool expectedSuccess = true;
        Like::Target expectedTarget = new() { ID = "9876543210", Type = Like::TargetType.Tweet };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<Like::LikeCreateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        Like::LikeCreateResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class LikeCreateResponseAccountTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Like::LikeCreateResponseAccount { ID = "42", Username = "example" };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Like::LikeCreateResponseAccount>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Like::LikeCreateResponseAccount copied = new(model);
...
{
    [Theory]
    [InlineData(Like::Action.CreateTweet)]
    [InlineData(Like::Action.DeleteTweet)]
    [InlineData(Like::Action.Like)]
    [InlineData(Like::Action.Unlike)]
    [InlineData(Like::Action.Retweet)]
    [InlineData(Like::Action.Unretweet)]
    [InlineData(Like::Action.Follow)]
    [InlineData(Like::Action.Unfollow)]
    [InlineData(Like::Action.RemoveFollower)]
    [InlineData(Like::Action.SendDm)]
    [InlineData(Like::Action.UploadMedia)]
    [InlineData(Like::Action.UpdateProfile)]
    [InlineData(Like::Action.UpdateAvatar)]
    [InlineData(Like::Action.UpdateBanner)]
    [InlineData(Like::Action.CreateCommunity)]
    [InlineData(Like::Action.DeleteCommunity)]
    [InlineData(Like::Action.JoinCommunity)]
    [InlineData(Like::Action.LeaveCommunity)]
    public void Validation_Works(Like::Action rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Like::Action> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Like::Action>>(
    ...
    [InlineData(Like::Action.JoinCommunity)]
    [InlineData(Like::Action.LeaveCommunity)]
    public void SerializationRoundtrip_Works(Like::Action rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Like::Action> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Like::Action>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class BillingTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        ApiEnum<string, Like::Status> expectedStatus = Like::Status.Charged;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Like::Billing>(
            json,
            ModelBase.SerializerOptions
        );
...
{
    [Theory]
    [InlineData(Like::Status.NotCharged)]
    [InlineData(Like::Status.Pending)]
    [InlineData(Like::Status.Charged)]
    [InlineData(Like::Status.ChargeFailed)]
    [InlineData(Like::Status.Refunded)]
    public void Validation_Works(Like::Status rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Like::Status> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Like::Status>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Like::Status.ChargeFailed)]
    [InlineData(Like::Status.Refunded)]
    public void SerializationRoundtrip_Works(Like::Status rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Like::Status> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Like::Status>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class NextActionTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        ApiEnum<string, Like::Type> expectedType = Like::Type.Poll;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Like::NextAction>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void OptionalNonNullablePropertiesUnsetAreNotSet_Works()
    {
        var model = new Like::NextAction { Type = Like::Type.Poll };
    ...
    public void CopyConstructor_Works()
    {
        ...
        Like::NextAction copied = new(model);
...
{
    [Theory]
    [InlineData(Like::Type.Poll)]
    [InlineData(Like::Type.Retry)]
    [InlineData(Like::Type.VerifyResult)]
    [InlineData(Like::Type.FixRequest)]
    public void Validation_Works(Like::Type rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Like::Type> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Like::Type>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Like::Type.VerifyResult)]
    [InlineData(Like::Type.FixRequest)]
    public void SerializationRoundtrip_Works(Like::Type rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Like::Type> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Like::Type>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class RequestTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Like::Request>(
            json,
            ModelBase.SerializerOptions
        );
...
public class ResultTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        ApiEnum<string, Like::ResultType> expectedType = Like::ResultType.StateChange;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Like::Result>(
            json,
            ModelBase.SerializerOptions
        );
...
{
    [Theory]
    [InlineData(Like::ResultType.Tweet)]
    [InlineData(Like::ResultType.DirectMessage)]
    [InlineData(Like::ResultType.Media)]
    [InlineData(Like::ResultType.Community)]
    [InlineData(Like::ResultType.StateChange)]
    public void Validation_Works(Like::ResultType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Like::ResultType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Like::ResultType>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Like::ResultType.Community)]
    [InlineData(Like::ResultType.StateChange)]
    public void SerializationRoundtrip_Works(Like::ResultType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Like::ResultType> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Like::ResultType>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class LikeCreateResponseStatusTest : TestBase
{
    [Theory]
    [InlineData(Like::LikeCreateResponseStatus.Accepted)]
    [InlineData(Like::LikeCreateResponseStatus.Dispatching)]
    [InlineData(Like::LikeCreateResponseStatus.PendingConfirmation)]
    [InlineData(Like::LikeCreateResponseStatus.Success)]
    [InlineData(Like::LikeCreateResponseStatus.Failed)]
    [InlineData(Like::LikeCreateResponseStatus.Expired)]
    public void Validation_Works(Like::LikeCreateResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Like::LikeCreateResponseStatus> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Like::LikeCreateResponseStatus>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Like::LikeCreateResponseStatus.Failed)]
    [InlineData(Like::LikeCreateResponseStatus.Expired)]
    public void SerializationRoundtrip_Works(Like::LikeCreateResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Like::LikeCreateResponseStatus> value = rawValue;
        ...
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, Like::LikeCreateResponseStatus>
...
public class TargetTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new Like::Target { ID = "9876543210", Type = Like::TargetType.Tweet };

        string expectedID = "9876543210";
        ApiEnum<string, Like::TargetType> expectedType = Like::TargetType.Tweet;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Like::Target>(
            json,
            ModelBase.SerializerOptions
        );
...
{
    [Theory]
    [InlineData(Like::TargetType.Tweet)]
    [InlineData(Like::TargetType.User)]
    [InlineData(Like::TargetType.Community)]
    public void Validation_Works(Like::TargetType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Like::TargetType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Like::TargetType>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Like::TargetType.User)]
    [InlineData(Like::TargetType.Community)]
    public void SerializationRoundtrip_Works(Like::TargetType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Like::TargetType> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Like::TargetType>>(
            json,
            ModelBase.SerializerOptions
        );
