...
public class TweetGetRepliesResponseTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        List<TweetGetRepliesResponseTweet> expectedTweets =
        [
            new()
            {
                ID = "id",
...
public class TweetGetRepliesResponseTweetTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new TweetGetRepliesResponseTweet
        {
            ID = "id",
            Text = "text",
            Author = new()
        ...
        TweetGetRepliesResponseTweetAuthor expectedAuthor = new()
        {
            ID = "id",
            Name = "name",
            Username = "username",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<TweetGetRepliesResponseTweet>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    {
        var model = new TweetGetRepliesResponseTweet { ID = "id", Text = "text" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        TweetGetRepliesResponseTweet copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class TweetGetRepliesResponseTweetAuthorTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new TweetGetRepliesResponseTweetAuthor
        {
            ID = "id",
            Name = "name",
            Username = "username",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<TweetGetRepliesResponseTweetAuthor>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        TweetGetRepliesResponseTweetAuthor copied = new(model);
