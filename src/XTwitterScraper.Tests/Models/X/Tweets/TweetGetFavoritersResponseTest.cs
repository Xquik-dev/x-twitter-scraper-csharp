...
public class TweetGetFavoritersResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new TweetGetFavoritersResponse
        {
            HasNextPage = true,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<TweetGetFavoritersResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        TweetGetFavoritersResponse copied = new(model);
