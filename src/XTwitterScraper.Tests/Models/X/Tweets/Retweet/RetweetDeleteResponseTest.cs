...
public class RetweetDeleteResponseTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new RetweetDeleteResponse
        {
            ...
            Action = RetweetDeleteResponseAction.Like,
            Billing = new()
            {
                Charged = true,
                ChargedCredits = "10",
                PlannedCredits = "10",
                Status = RetweetDeleteResponseBillingStatus.Charged,
            },
            Charged = true,
            ChargedCredits = "10",
            NextAction = new()
            {
                Type = RetweetDeleteResponseNextActionType.Poll,
                AfterMs = 2000,
            ...
            Result = new()
            {
                ID = "9876543210",
                State = "liked",
                Type = RetweetDeleteResponseResultType.StateChange,
            },
            Retryable = false,
            SafeToRetry = false,
            SendDispatched = true,
            Status = RetweetDeleteResponseStatus.Success,
            StatusUrl = "/api/v1/x/write-actions/12345",
            Success = true,
            Target = new() { ID = "9876543210", Type = RetweetDeleteResponseTargetType.Tweet },
            TargetID = "9876543210",
            Terminal = true,
            WriteActionID = "12345",
        ...
        RetweetDeleteResponseAccount expectedAccount = new() { ID = "42", Username = "example" };
        ApiEnum<string, RetweetDeleteResponseAction> expectedAction =
            RetweetDeleteResponseAction.Like;
        RetweetDeleteResponseBilling expectedBilling = new()
        {
            Charged = true,
            ChargedCredits = "10",
            PlannedCredits = "10",
        ...
        RetweetDeleteResponseNextAction expectedNextAction = new()
        {
            Type = RetweetDeleteResponseNextActionType.Poll,
            AfterMs = 2000,
            RequiresNewIdempotencyKey = true,
        ...
        RetweetDeleteResponseRequest expectedRequest = new()
        {
            Hash = "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
            Payload = new Dictionary<string, JsonElement>()
            {
        ...
        RetweetDeleteResponseResult expectedResult = new()
        {
            ID = "9876543210",
            State = "liked",
            Type = RetweetDeleteResponseResultType.StateChange,
        ...
        ApiEnum<string, RetweetDeleteResponseStatus> expectedStatus =
            RetweetDeleteResponseStatus.Success;
        string expectedStatusUrl = "/api/v1/x/write-actions/12345";
        bool expectedSuccess = true;
        RetweetDeleteResponseTarget expectedTarget = new()
        {
            ID = "9876543210",
            Type = RetweetDeleteResponseTargetType.Tweet,
        };
...
public class RetweetDeleteResponseAccountTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new RetweetDeleteResponseAccount { ID = "42", Username = "example" };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<RetweetDeleteResponseAccount>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        RetweetDeleteResponseAccount copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class RetweetDeleteResponseActionTest : TestBase
{
    [Theory]
    [InlineData(RetweetDeleteResponseAction.CreateTweet)]
    [InlineData(RetweetDeleteResponseAction.DeleteTweet)]
    [InlineData(RetweetDeleteResponseAction.Like)]
    [InlineData(RetweetDeleteResponseAction.Unlike)]
    [InlineData(RetweetDeleteResponseAction.Retweet)]
    [InlineData(RetweetDeleteResponseAction.Unretweet)]
    [InlineData(RetweetDeleteResponseAction.Follow)]
    [InlineData(RetweetDeleteResponseAction.Unfollow)]
    [InlineData(RetweetDeleteResponseAction.RemoveFollower)]
    [InlineData(RetweetDeleteResponseAction.SendDm)]
    [InlineData(RetweetDeleteResponseAction.UploadMedia)]
    [InlineData(RetweetDeleteResponseAction.UpdateProfile)]
    [InlineData(RetweetDeleteResponseAction.UpdateAvatar)]
    [InlineData(RetweetDeleteResponseAction.UpdateBanner)]
    [InlineData(RetweetDeleteResponseAction.CreateCommunity)]
    [InlineData(RetweetDeleteResponseAction.DeleteCommunity)]
    [InlineData(RetweetDeleteResponseAction.JoinCommunity)]
    [InlineData(RetweetDeleteResponseAction.LeaveCommunity)]
    public void Validation_Works(RetweetDeleteResponseAction rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, RetweetDeleteResponseAction> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, RetweetDeleteResponseAction>>(
    ...
    [InlineData(RetweetDeleteResponseAction.JoinCommunity)]
    [InlineData(RetweetDeleteResponseAction.LeaveCommunity)]
    public void SerializationRoundtrip_Works(RetweetDeleteResponseAction rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, RetweetDeleteResponseAction> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, RetweetDeleteResponseAction>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class RetweetDeleteResponseBillingTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new RetweetDeleteResponseBilling
        {
            Charged = true,
            ChargedCredits = "10",
            PlannedCredits = "10",
        ...
        ApiEnum<string, RetweetDeleteResponseBillingStatus> expectedStatus =
            RetweetDeleteResponseBillingStatus.Charged;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<RetweetDeleteResponseBilling>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        RetweetDeleteResponseBilling copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class RetweetDeleteResponseBillingStatusTest : TestBase
{
    [Theory]
    [InlineData(RetweetDeleteResponseBillingStatus.NotCharged)]
    [InlineData(RetweetDeleteResponseBillingStatus.Pending)]
    [InlineData(RetweetDeleteResponseBillingStatus.Charged)]
    [InlineData(RetweetDeleteResponseBillingStatus.ChargeFailed)]
    [InlineData(RetweetDeleteResponseBillingStatus.Refunded)]
    public void Validation_Works(RetweetDeleteResponseBillingStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, RetweetDeleteResponseBillingStatus> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, RetweetDeleteResponseBillingStatus>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(RetweetDeleteResponseBillingStatus.ChargeFailed)]
    [InlineData(RetweetDeleteResponseBillingStatus.Refunded)]
    public void SerializationRoundtrip_Works(RetweetDeleteResponseBillingStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, RetweetDeleteResponseBillingStatus> value = rawValue;
...
public class RetweetDeleteResponseNextActionTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new RetweetDeleteResponseNextAction
        {
            Type = RetweetDeleteResponseNextActionType.Poll,
            AfterMs = 2000,
            RequiresNewIdempotencyKey = true,
        ...
        ApiEnum<string, RetweetDeleteResponseNextActionType> expectedType =
            RetweetDeleteResponseNextActionType.Poll;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<RetweetDeleteResponseNextAction>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        RetweetDeleteResponseNextAction copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class RetweetDeleteResponseNextActionTypeTest : TestBase
{
    [Theory]
    [InlineData(RetweetDeleteResponseNextActionType.Poll)]
    [InlineData(RetweetDeleteResponseNextActionType.Retry)]
    [InlineData(RetweetDeleteResponseNextActionType.VerifyResult)]
    [InlineData(RetweetDeleteResponseNextActionType.FixRequest)]
    public void Validation_Works(RetweetDeleteResponseNextActionType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, RetweetDeleteResponseNextActionType> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(RetweetDeleteResponseNextActionType.VerifyResult)]
    [InlineData(RetweetDeleteResponseNextActionType.FixRequest)]
    public void SerializationRoundtrip_Works(RetweetDeleteResponseNextActionType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, RetweetDeleteResponseNextActionType> value = rawValue;
...
public class RetweetDeleteResponseRequestTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new RetweetDeleteResponseRequest
        {
            Hash = "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
            Payload = new Dictionary<string, JsonElement>()
            {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<RetweetDeleteResponseRequest>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        RetweetDeleteResponseRequest copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class RetweetDeleteResponseResultTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new RetweetDeleteResponseResult
        {
            ID = "9876543210",
            State = "liked",
            Type = RetweetDeleteResponseResultType.StateChange,
        ...
        ApiEnum<string, RetweetDeleteResponseResultType> expectedType =
            RetweetDeleteResponseResultType.StateChange;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<RetweetDeleteResponseResult>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        RetweetDeleteResponseResult copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class RetweetDeleteResponseResultTypeTest : TestBase
{
    [Theory]
    [InlineData(RetweetDeleteResponseResultType.Tweet)]
    [InlineData(RetweetDeleteResponseResultType.DirectMessage)]
    [InlineData(RetweetDeleteResponseResultType.Media)]
    [InlineData(RetweetDeleteResponseResultType.Community)]
    [InlineData(RetweetDeleteResponseResultType.StateChange)]
    public void Validation_Works(RetweetDeleteResponseResultType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, RetweetDeleteResponseResultType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, RetweetDeleteResponseResultType>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(RetweetDeleteResponseResultType.Community)]
    [InlineData(RetweetDeleteResponseResultType.StateChange)]
    public void SerializationRoundtrip_Works(RetweetDeleteResponseResultType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, RetweetDeleteResponseResultType> value = rawValue;
        ...
        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, RetweetDeleteResponseResultType>
        >(json, ModelBase.SerializerOptions);
...
public class RetweetDeleteResponseStatusTest : TestBase
{
    [Theory]
    [InlineData(RetweetDeleteResponseStatus.Accepted)]
    [InlineData(RetweetDeleteResponseStatus.Dispatching)]
    [InlineData(RetweetDeleteResponseStatus.PendingConfirmation)]
    [InlineData(RetweetDeleteResponseStatus.Success)]
    [InlineData(RetweetDeleteResponseStatus.Failed)]
    [InlineData(RetweetDeleteResponseStatus.Expired)]
    public void Validation_Works(RetweetDeleteResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, RetweetDeleteResponseStatus> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, RetweetDeleteResponseStatus>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(RetweetDeleteResponseStatus.Failed)]
    [InlineData(RetweetDeleteResponseStatus.Expired)]
    public void SerializationRoundtrip_Works(RetweetDeleteResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, RetweetDeleteResponseStatus> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, RetweetDeleteResponseStatus>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class RetweetDeleteResponseTargetTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new RetweetDeleteResponseTarget
        {
            ID = "9876543210",
            Type = RetweetDeleteResponseTargetType.Tweet,
        };
        ...
        string expectedID = "9876543210";
        ApiEnum<string, RetweetDeleteResponseTargetType> expectedType =
            RetweetDeleteResponseTargetType.Tweet;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<RetweetDeleteResponseTarget>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        RetweetDeleteResponseTarget copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class RetweetDeleteResponseTargetTypeTest : TestBase
{
    [Theory]
    [InlineData(RetweetDeleteResponseTargetType.Tweet)]
    [InlineData(RetweetDeleteResponseTargetType.User)]
    [InlineData(RetweetDeleteResponseTargetType.Community)]
    public void Validation_Works(RetweetDeleteResponseTargetType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, RetweetDeleteResponseTargetType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, RetweetDeleteResponseTargetType>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(RetweetDeleteResponseTargetType.User)]
    [InlineData(RetweetDeleteResponseTargetType.Community)]
    public void SerializationRoundtrip_Works(RetweetDeleteResponseTargetType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, RetweetDeleteResponseTargetType> value = rawValue;
        ...
        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, RetweetDeleteResponseTargetType>
        >(json, ModelBase.SerializerOptions);
