...
public class TweetGetThreadResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new TweetGetThreadResponse
        {
            HasNextPage = true,
        ...
        List<TweetGetThreadResponseTweet> expectedTweets =
        [
            new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<TweetGetThreadResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        TweetGetThreadResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class TweetGetThreadResponseTweetTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new TweetGetThreadResponseTweet
        {
            ID = "id",
            Text = "text",
            Author = new()
        ...
        TweetGetThreadResponseTweetAuthor expectedAuthor = new()
        {
            ID = "id",
            Name = "name",
            Username = "username",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<TweetGetThreadResponseTweet>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    {
        var model = new TweetGetThreadResponseTweet { ID = "id", Text = "text" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        TweetGetThreadResponseTweet copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class TweetGetThreadResponseTweetAuthorTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new TweetGetThreadResponseTweetAuthor
        {
            ID = "id",
            Name = "name",
            Username = "username",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<TweetGetThreadResponseTweetAuthor>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        TweetGetThreadResponseTweetAuthor copied = new(model);
