...
public class TweetCreateResponseTest : TestBase
{
    ...
    {
        var model = new Tweets::TweetCreateResponse
        {
            ID = "12345",
            Account = new() { ID = "42", Username = "example" },
            Action = Tweets::Action.Like,
            Billing = new()
            {
                Charged = true,
                ChargedCredits = "10",
                PlannedCredits = "10",
                Status = Tweets::Status.Charged,
            },
            Charged = true,
            ChargedCredits = "10",
            NextAction = new()
            {
                Type = Tweets::Type.Poll,
                AfterMs = 2000,
            ...
            Result = new()
            {
                ID = "9876543210",
                State = "liked",
                Type = Tweets::ResultType.StateChange,
            },
            Retryable = false,
            SafeToRetry = false,
            SendDispatched = true,
            Status = Tweets::TweetCreateResponseStatus.Success,
            StatusUrl = "/api/v1/x/write-actions/12345",
            Success = true,
            Target = new() { ID = "9876543210", Type = Tweets::TargetType.Tweet },
            TargetID = "9876543210",
            Terminal = true,
            WriteActionID = "12345",
        ...
        Tweets::TweetCreateResponseAccount expectedAccount = new()
        {
            ID = "42",
            Username = "example",
        };
        ApiEnum<string, Tweets::Action> expectedAction = Tweets::Action.Like;
        Tweets::Billing expectedBilling = new()
        {
            Charged = true,
            ChargedCredits = "10",
            PlannedCredits = "10",
        ...
        Tweets::NextAction expectedNextAction = new()
        {
            Type = Tweets::Type.Poll,
            AfterMs = 2000,
            RequiresNewIdempotencyKey = true,
        ...
        Tweets::Request expectedRequest = new()
        {
            Hash = "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
            Payload = new Dictionary<string, JsonElement>()
            {
        ...
        Tweets::Result expectedResult = new()
        {
            ID = "9876543210",
            State = "liked",
            Type = Tweets::ResultType.StateChange,
        ...
        ApiEnum<string, Tweets::TweetCreateResponseStatus> expectedStatus =
            Tweets::TweetCreateResponseStatus.Success;
        string expectedStatusUrl = "/api/v1/x/write-actions/12345";
        bool expectedSuccess = true;
        Tweets::Target expectedTarget = new()
        {
            ID = "9876543210",
            Type = Tweets::TargetType.Tweet,
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<Tweets::TweetCreateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        Tweets::TweetCreateResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class TweetCreateResponseAccountTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Tweets::TweetCreateResponseAccount { ID = "42", Username = "example" };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Tweets::TweetCreateResponseAccount>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Tweets::TweetCreateResponseAccount copied = new(model);
...
{
    [Theory]
    [InlineData(Tweets::Action.CreateTweet)]
    [InlineData(Tweets::Action.DeleteTweet)]
    [InlineData(Tweets::Action.Like)]
    [InlineData(Tweets::Action.Unlike)]
    [InlineData(Tweets::Action.Retweet)]
    [InlineData(Tweets::Action.Unretweet)]
    [InlineData(Tweets::Action.Follow)]
    [InlineData(Tweets::Action.Unfollow)]
    [InlineData(Tweets::Action.RemoveFollower)]
    [InlineData(Tweets::Action.SendDm)]
    [InlineData(Tweets::Action.UploadMedia)]
    [InlineData(Tweets::Action.UpdateProfile)]
    [InlineData(Tweets::Action.UpdateAvatar)]
    [InlineData(Tweets::Action.UpdateBanner)]
    [InlineData(Tweets::Action.CreateCommunity)]
    [InlineData(Tweets::Action.DeleteCommunity)]
    [InlineData(Tweets::Action.JoinCommunity)]
    [InlineData(Tweets::Action.LeaveCommunity)]
    public void Validation_Works(Tweets::Action rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Tweets::Action> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Tweets::Action>>(
    ...
    [InlineData(Tweets::Action.JoinCommunity)]
    [InlineData(Tweets::Action.LeaveCommunity)]
    public void SerializationRoundtrip_Works(Tweets::Action rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Tweets::Action> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Tweets::Action>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class BillingTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        ApiEnum<string, Tweets::Status> expectedStatus = Tweets::Status.Charged;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Tweets::Billing>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Tweets::Billing copied = new(model);
...
{
    [Theory]
    [InlineData(Tweets::Status.NotCharged)]
    [InlineData(Tweets::Status.Pending)]
    [InlineData(Tweets::Status.Charged)]
    [InlineData(Tweets::Status.ChargeFailed)]
    [InlineData(Tweets::Status.Refunded)]
    public void Validation_Works(Tweets::Status rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Tweets::Status> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Tweets::Status>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Tweets::Status.ChargeFailed)]
    [InlineData(Tweets::Status.Refunded)]
    public void SerializationRoundtrip_Works(Tweets::Status rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Tweets::Status> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Tweets::Status>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class NextActionTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new Tweets::NextAction
        {
            Type = Tweets::Type.Poll,
            AfterMs = 2000,
            RequiresNewIdempotencyKey = true,
        ...
        ApiEnum<string, Tweets::Type> expectedType = Tweets::Type.Poll;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Tweets::NextAction>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void OptionalNonNullablePropertiesUnsetAreNotSet_Works()
    {
        var model = new Tweets::NextAction { Type = Tweets::Type.Poll };
    ...
    public void CopyConstructor_Works()
    {
        ...
        Tweets::NextAction copied = new(model);
...
{
    [Theory]
    [InlineData(Tweets::Type.Poll)]
    [InlineData(Tweets::Type.Retry)]
    [InlineData(Tweets::Type.VerifyResult)]
    [InlineData(Tweets::Type.FixRequest)]
    public void Validation_Works(Tweets::Type rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Tweets::Type> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Tweets::Type>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Tweets::Type.VerifyResult)]
    [InlineData(Tweets::Type.FixRequest)]
    public void SerializationRoundtrip_Works(Tweets::Type rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Tweets::Type> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Tweets::Type>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class RequestTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Tweets::Request>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Tweets::Request copied = new(model);
...
public class ResultTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        ApiEnum<string, Tweets::ResultType> expectedType = Tweets::ResultType.StateChange;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Tweets::Result>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Tweets::Result copied = new(model);
...
{
    [Theory]
    [InlineData(Tweets::ResultType.Tweet)]
    [InlineData(Tweets::ResultType.DirectMessage)]
    [InlineData(Tweets::ResultType.Media)]
    [InlineData(Tweets::ResultType.Community)]
    [InlineData(Tweets::ResultType.StateChange)]
    public void Validation_Works(Tweets::ResultType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Tweets::ResultType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Tweets::ResultType>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Tweets::ResultType.Community)]
    [InlineData(Tweets::ResultType.StateChange)]
    public void SerializationRoundtrip_Works(Tweets::ResultType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Tweets::ResultType> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Tweets::ResultType>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class TweetCreateResponseStatusTest : TestBase
{
    [Theory]
    [InlineData(Tweets::TweetCreateResponseStatus.Accepted)]
    [InlineData(Tweets::TweetCreateResponseStatus.Dispatching)]
    [InlineData(Tweets::TweetCreateResponseStatus.PendingConfirmation)]
    [InlineData(Tweets::TweetCreateResponseStatus.Success)]
    [InlineData(Tweets::TweetCreateResponseStatus.Failed)]
    [InlineData(Tweets::TweetCreateResponseStatus.Expired)]
    public void Validation_Works(Tweets::TweetCreateResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Tweets::TweetCreateResponseStatus> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Tweets::TweetCreateResponseStatus>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Tweets::TweetCreateResponseStatus.Failed)]
    [InlineData(Tweets::TweetCreateResponseStatus.Expired)]
    public void SerializationRoundtrip_Works(Tweets::TweetCreateResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Tweets::TweetCreateResponseStatus> value = rawValue;
        ...
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, Tweets::TweetCreateResponseStatus>
...
public class TargetTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new Tweets::Target { ID = "9876543210", Type = Tweets::TargetType.Tweet };

        string expectedID = "9876543210";
        ApiEnum<string, Tweets::TargetType> expectedType = Tweets::TargetType.Tweet;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Tweets::Target>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Tweets::Target copied = new(model);
...
{
    [Theory]
    [InlineData(Tweets::TargetType.Tweet)]
    [InlineData(Tweets::TargetType.User)]
    [InlineData(Tweets::TargetType.Community)]
    public void Validation_Works(Tweets::TargetType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Tweets::TargetType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Tweets::TargetType>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Tweets::TargetType.User)]
    [InlineData(Tweets::TargetType.Community)]
    public void SerializationRoundtrip_Works(Tweets::TargetType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Tweets::TargetType> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Tweets::TargetType>>(
            json,
            ModelBase.SerializerOptions
        );
