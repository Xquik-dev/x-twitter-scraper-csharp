...
public class WriteActionRetrieveResponseTest : TestBase
{
    ...
    {
        var model = new WriteActions::WriteActionRetrieveResponse
        {
            ID = "12345",
            Account = new() { ID = "42", Username = "example" },
            Action = WriteActions::Action.Like,
            Billing = new()
            {
                Charged = true,
                ChargedCredits = "10",
                PlannedCredits = "10",
                Status = WriteActions::Status.Charged,
            },
            Charged = true,
            ChargedCredits = "10",
            NextAction = new()
            {
                Type = WriteActions::Type.Poll,
                AfterMs = 2000,
            ...
            Result = new()
            {
                ID = "9876543210",
                State = "liked",
                Type = WriteActions::ResultType.StateChange,
            },
            Retryable = false,
            SafeToRetry = false,
            SendDispatched = true,
            Status = WriteActions::WriteActionRetrieveResponseStatus.Success,
            StatusUrl = "/api/v1/x/write-actions/12345",
            Success = true,
            Target = new() { ID = "9876543210", Type = WriteActions::TargetType.Tweet },
            TargetID = "9876543210",
            Terminal = true,
            WriteActionID = "12345",
        ...
        WriteActions::WriteActionRetrieveResponseAccount expectedAccount = new()
        {
            ID = "42",
            Username = "example",
        };
        ApiEnum<string, WriteActions::Action> expectedAction = WriteActions::Action.Like;
        WriteActions::Billing expectedBilling = new()
        {
            Charged = true,
            ChargedCredits = "10",
            PlannedCredits = "10",
        ...
        WriteActions::NextAction expectedNextAction = new()
        {
            Type = WriteActions::Type.Poll,
            AfterMs = 2000,
            RequiresNewIdempotencyKey = true,
        ...
        WriteActions::Request expectedRequest = new()
        {
            Hash = "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
            Payload = new Dictionary<string, JsonElement>()
            {
        ...
        WriteActions::Result expectedResult = new()
        {
            ID = "9876543210",
            State = "liked",
            Type = WriteActions::ResultType.StateChange,
        ...
        ApiEnum<string, WriteActions::WriteActionRetrieveResponseStatus> expectedStatus =
            WriteActions::WriteActionRetrieveResponseStatus.Success;
        string expectedStatusUrl = "/api/v1/x/write-actions/12345";
        bool expectedSuccess = true;
        WriteActions::Target expectedTarget = new()
        {
            ID = "9876543210",
            Type = WriteActions::TargetType.Tweet,
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<WriteActions::WriteActionRetrieveResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        WriteActions::WriteActionRetrieveResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class WriteActionRetrieveResponseAccountTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new WriteActions::WriteActionRetrieveResponseAccount
        {
            ID = "42",
            Username = "example",
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<WriteActions::WriteActionRetrieveResponseAccount>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        WriteActions::WriteActionRetrieveResponseAccount copied = new(model);
...
{
    [Theory]
    [InlineData(WriteActions::Action.CreateTweet)]
    [InlineData(WriteActions::Action.DeleteTweet)]
    [InlineData(WriteActions::Action.Like)]
    [InlineData(WriteActions::Action.Unlike)]
    [InlineData(WriteActions::Action.Retweet)]
    [InlineData(WriteActions::Action.Unretweet)]
    [InlineData(WriteActions::Action.Follow)]
    [InlineData(WriteActions::Action.Unfollow)]
    [InlineData(WriteActions::Action.RemoveFollower)]
    [InlineData(WriteActions::Action.SendDm)]
    [InlineData(WriteActions::Action.UploadMedia)]
    [InlineData(WriteActions::Action.UpdateProfile)]
    [InlineData(WriteActions::Action.UpdateAvatar)]
    [InlineData(WriteActions::Action.UpdateBanner)]
    [InlineData(WriteActions::Action.CreateCommunity)]
    [InlineData(WriteActions::Action.DeleteCommunity)]
    [InlineData(WriteActions::Action.JoinCommunity)]
    [InlineData(WriteActions::Action.LeaveCommunity)]
    public void Validation_Works(WriteActions::Action rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, WriteActions::Action> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, WriteActions::Action>>(
    ...
    [InlineData(WriteActions::Action.JoinCommunity)]
    [InlineData(WriteActions::Action.LeaveCommunity)]
    public void SerializationRoundtrip_Works(WriteActions::Action rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, WriteActions::Action> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, WriteActions::Action>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class BillingTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new WriteActions::Billing
        {
            Charged = true,
            ChargedCredits = "10",
            PlannedCredits = "10",
        ...
        ApiEnum<string, WriteActions::Status> expectedStatus = WriteActions::Status.Charged;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<WriteActions::Billing>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        WriteActions::Billing copied = new(model);
...
{
    [Theory]
    [InlineData(WriteActions::Status.NotCharged)]
    [InlineData(WriteActions::Status.Pending)]
    [InlineData(WriteActions::Status.Charged)]
    [InlineData(WriteActions::Status.ChargeFailed)]
    [InlineData(WriteActions::Status.Refunded)]
    public void Validation_Works(WriteActions::Status rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, WriteActions::Status> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, WriteActions::Status>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(WriteActions::Status.ChargeFailed)]
    [InlineData(WriteActions::Status.Refunded)]
    public void SerializationRoundtrip_Works(WriteActions::Status rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, WriteActions::Status> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, WriteActions::Status>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class NextActionTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new WriteActions::NextAction
        {
            Type = WriteActions::Type.Poll,
            AfterMs = 2000,
            RequiresNewIdempotencyKey = true,
        ...
        ApiEnum<string, WriteActions::Type> expectedType = WriteActions::Type.Poll;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<WriteActions::NextAction>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void OptionalNonNullablePropertiesUnsetAreNotSet_Works()
    {
        var model = new WriteActions::NextAction { Type = WriteActions::Type.Poll };
    ...
    public void CopyConstructor_Works()
    {
        ...
        WriteActions::NextAction copied = new(model);
...
{
    [Theory]
    [InlineData(WriteActions::Type.Poll)]
    [InlineData(WriteActions::Type.Retry)]
    [InlineData(WriteActions::Type.VerifyResult)]
    [InlineData(WriteActions::Type.FixRequest)]
    public void Validation_Works(WriteActions::Type rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, WriteActions::Type> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, WriteActions::Type>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(WriteActions::Type.VerifyResult)]
    [InlineData(WriteActions::Type.FixRequest)]
    public void SerializationRoundtrip_Works(WriteActions::Type rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, WriteActions::Type> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, WriteActions::Type>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class RequestTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new WriteActions::Request
        {
            Hash = "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
            Payload = new Dictionary<string, JsonElement>()
            {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<WriteActions::Request>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        WriteActions::Request copied = new(model);
...
public class ResultTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new WriteActions::Result
        {
            ID = "9876543210",
            State = "liked",
            Type = WriteActions::ResultType.StateChange,
        ...
        ApiEnum<string, WriteActions::ResultType> expectedType =
            WriteActions::ResultType.StateChange;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<WriteActions::Result>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        WriteActions::Result copied = new(model);
...
{
    [Theory]
    [InlineData(WriteActions::ResultType.Tweet)]
    [InlineData(WriteActions::ResultType.DirectMessage)]
    [InlineData(WriteActions::ResultType.Media)]
    [InlineData(WriteActions::ResultType.Community)]
    [InlineData(WriteActions::ResultType.StateChange)]
    public void Validation_Works(WriteActions::ResultType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, WriteActions::ResultType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, WriteActions::ResultType>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(WriteActions::ResultType.Community)]
    [InlineData(WriteActions::ResultType.StateChange)]
    public void SerializationRoundtrip_Works(WriteActions::ResultType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, WriteActions::ResultType> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, WriteActions::ResultType>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class WriteActionRetrieveResponseStatusTest : TestBase
{
    [Theory]
    [InlineData(WriteActions::WriteActionRetrieveResponseStatus.Accepted)]
    [InlineData(WriteActions::WriteActionRetrieveResponseStatus.Dispatching)]
    [InlineData(WriteActions::WriteActionRetrieveResponseStatus.PendingConfirmation)]
    [InlineData(WriteActions::WriteActionRetrieveResponseStatus.Success)]
    [InlineData(WriteActions::WriteActionRetrieveResponseStatus.Failed)]
    [InlineData(WriteActions::WriteActionRetrieveResponseStatus.Expired)]
    public void Validation_Works(WriteActions::WriteActionRetrieveResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, WriteActions::WriteActionRetrieveResponseStatus> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<
            ApiEnum<string, WriteActions::WriteActionRetrieveResponseStatus>
    ...
    [InlineData(WriteActions::WriteActionRetrieveResponseStatus.Expired)]
    public void SerializationRoundtrip_Works(
        WriteActions::WriteActionRetrieveResponseStatus rawValue
    )
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, WriteActions::WriteActionRetrieveResponseStatus> value = rawValue;
...
public class TargetTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new WriteActions::Target
        {
            ID = "9876543210",
            Type = WriteActions::TargetType.Tweet,
        };
        ...
        string expectedID = "9876543210";
        ApiEnum<string, WriteActions::TargetType> expectedType = WriteActions::TargetType.Tweet;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<WriteActions::Target>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        WriteActions::Target copied = new(model);
...
{
    [Theory]
    [InlineData(WriteActions::TargetType.Tweet)]
    [InlineData(WriteActions::TargetType.User)]
    [InlineData(WriteActions::TargetType.Community)]
    public void Validation_Works(WriteActions::TargetType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, WriteActions::TargetType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, WriteActions::TargetType>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(WriteActions::TargetType.User)]
    [InlineData(WriteActions::TargetType.Community)]
    public void SerializationRoundtrip_Works(WriteActions::TargetType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, WriteActions::TargetType> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, WriteActions::TargetType>>(
            json,
            ModelBase.SerializerOptions
        );
