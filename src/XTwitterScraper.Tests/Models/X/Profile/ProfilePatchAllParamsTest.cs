...
public class ProfilePatchAllParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new ProfilePatchAllParams
        {
            Account = "account",
    ...
    {
        var parameters = new ProfilePatchAllParams { Account = "account" };
    ...
    {
        ProfilePatchAllParams parameters = new() { Account = "account" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ProfilePatchAllParams copied = new(parameters);
