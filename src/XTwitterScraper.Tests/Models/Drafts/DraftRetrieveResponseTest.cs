...
public class DraftRetrieveResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new DraftRetrieveResponse
        {
            ID = "42",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<DraftRetrieveResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        DraftRetrieveResponse copied = new(model);
