...
public class StyleAnalyzeResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new StyleAnalyzeResponse
        {
        ...
        List<StyleAnalyzeResponseTweet> expectedTweets =
        [
            new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<StyleAnalyzeResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        StyleAnalyzeResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class StyleAnalyzeResponseTweetTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new StyleAnalyzeResponseTweet
        {
            ID = "id",
            Text = "text",
            AuthorUsername = "authorUsername",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<StyleAnalyzeResponseTweet>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    {
        var model = new StyleAnalyzeResponseTweet { ID = "id", Text = "text" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        StyleAnalyzeResponseTweet copied = new(model);
