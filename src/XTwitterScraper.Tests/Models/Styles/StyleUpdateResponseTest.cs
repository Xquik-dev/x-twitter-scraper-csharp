...
public class StyleUpdateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new StyleUpdateResponse
        {
        ...
        List<StyleUpdateResponseTweet> expectedTweets =
        [
            new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<StyleUpdateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        StyleUpdateResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class StyleUpdateResponseTweetTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new StyleUpdateResponseTweet
        {
            ID = "id",
            Text = "text",
            AuthorUsername = "authorUsername",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<StyleUpdateResponseTweet>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    {
        var model = new StyleUpdateResponseTweet { ID = "id", Text = "text" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        StyleUpdateResponseTweet copied = new(model);
