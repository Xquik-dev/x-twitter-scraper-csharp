...
public class GuestWalletTopupParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new GuestWalletTopupParams
        {
            AmountMinor = 1000,
    ...
    {
        GuestWalletTopupParams parameters = new()
        {
            AmountMinor = 1000,
        ...
        Assert.True(
            TestBase.UrisEqual(new Uri("https://xquik.com/api/v1/guest-wallets/topups"), url)
        );
    }
    ...
    public void CopyConstructor_Works()
    {
        ...
        GuestWalletTopupParams copied = new(parameters);
