...
public class IntegrationCreateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new IntegrationCreateResponse
        {
            ID = "id",
            ...
            EventTypes = [IntegrationCreateResponseEventType.TweetNew],
            IsActive = true,
            Name = "name",
            Type = IntegrationCreateResponseType.Telegram,
        ...
        List<ApiEnum<string, IntegrationCreateResponseEventType>> expectedEventTypes =
        [
            IntegrationCreateResponseEventType.TweetNew,
        ];
        bool expectedIsActive = true;
        string expectedName = "name";
        ApiEnum<string, IntegrationCreateResponseType> expectedType =
            IntegrationCreateResponseType.Telegram;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<IntegrationCreateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        IntegrationCreateResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class IntegrationCreateResponseEventTypeTest : TestBase
{
    [Theory]
    [InlineData(IntegrationCreateResponseEventType.TweetNew)]
    [InlineData(IntegrationCreateResponseEventType.TweetReply)]
    [InlineData(IntegrationCreateResponseEventType.TweetRetweet)]
    [InlineData(IntegrationCreateResponseEventType.TweetQuote)]
    [InlineData(IntegrationCreateResponseEventType.FollowerGained)]
    [InlineData(IntegrationCreateResponseEventType.FollowerLost)]
    public void Validation_Works(IntegrationCreateResponseEventType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, IntegrationCreateResponseEventType> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, IntegrationCreateResponseEventType>>(
    ...
    [InlineData(IntegrationCreateResponseEventType.FollowerGained)]
    [InlineData(IntegrationCreateResponseEventType.FollowerLost)]
    public void SerializationRoundtrip_Works(IntegrationCreateResponseEventType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, IntegrationCreateResponseEventType> value = rawValue;
        ...
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, IntegrationCreateResponseEventType>
...
public class IntegrationCreateResponseTypeTest : TestBase
{
    [Theory]
    [InlineData(IntegrationCreateResponseType.Telegram)]
    public void Validation_Works(IntegrationCreateResponseType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, IntegrationCreateResponseType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, IntegrationCreateResponseType>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [Theory]
    [InlineData(IntegrationCreateResponseType.Telegram)]
    public void SerializationRoundtrip_Works(IntegrationCreateResponseType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, IntegrationCreateResponseType> value = rawValue;
        ...
        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, IntegrationCreateResponseType>
        >(json, ModelBase.SerializerOptions);
