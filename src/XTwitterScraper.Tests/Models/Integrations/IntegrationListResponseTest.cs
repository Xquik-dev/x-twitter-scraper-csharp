...
public class IntegrationListResponseTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        List<IntegrationListResponseIntegration> expectedIntegrations =
        [
            new()
            {
                ID = "id",
...
public class IntegrationListResponseIntegrationTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<IntegrationListResponseIntegration>(
            json,
            ModelBase.SerializerOptions
        );
...
public class IntegrationListResponseIntegrationEventTypeTest : TestBase
{
    [Theory]
    [InlineData(IntegrationListResponseIntegrationEventType.TweetNew)]
    [InlineData(IntegrationListResponseIntegrationEventType.TweetReply)]
    [InlineData(IntegrationListResponseIntegrationEventType.TweetRetweet)]
    [InlineData(IntegrationListResponseIntegrationEventType.TweetQuote)]
    [InlineData(IntegrationListResponseIntegrationEventType.FollowerGained)]
    [InlineData(IntegrationListResponseIntegrationEventType.FollowerLost)]
    public void Validation_Works(IntegrationListResponseIntegrationEventType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, IntegrationListResponseIntegrationEventType> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(IntegrationListResponseIntegrationEventType.FollowerGained)]
    [InlineData(IntegrationListResponseIntegrationEventType.FollowerLost)]
    public void SerializationRoundtrip_Works(IntegrationListResponseIntegrationEventType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, IntegrationListResponseIntegrationEventType> value = rawValue;
...
public class IntegrationListResponseIntegrationTypeTest : TestBase
{
    [Theory]
    [InlineData(IntegrationListResponseIntegrationType.Telegram)]
    public void Validation_Works(IntegrationListResponseIntegrationType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, IntegrationListResponseIntegrationType> value = rawValue;
        value.Validate();
    }
    ...
    [Theory]
    [InlineData(IntegrationListResponseIntegrationType.Telegram)]
    public void SerializationRoundtrip_Works(IntegrationListResponseIntegrationType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, IntegrationListResponseIntegrationType> value = rawValue;
