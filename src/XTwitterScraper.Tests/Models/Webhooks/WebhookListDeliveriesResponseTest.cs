...
public class WebhookListDeliveriesResponseTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        List<WebhookListDeliveriesResponseDelivery> expectedDeliveries =
        [
            new()
            {
                ID = "id",
...
public class WebhookListDeliveriesResponseDeliveryTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new WebhookListDeliveriesResponseDelivery
        {
            ID = "id",
            Attempts = 0,
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<WebhookListDeliveriesResponseDelivery>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        WebhookListDeliveriesResponseDelivery copied = new(model);
