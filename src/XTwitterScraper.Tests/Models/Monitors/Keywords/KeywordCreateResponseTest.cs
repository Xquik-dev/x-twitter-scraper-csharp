...
public class KeywordCreateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new KeywordCreateResponse
        {
            ID = "21",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<KeywordCreateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        KeywordCreateResponse copied = new(model);
