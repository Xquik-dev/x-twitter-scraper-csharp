...
public class KeywordDeactivateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new KeywordDeactivateResponse { };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<KeywordDeactivateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        KeywordDeactivateResponse copied = new(model);
