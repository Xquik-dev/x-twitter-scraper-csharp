...
public class KeywordRetrieveResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new KeywordRetrieveResponse
        {
            ID = "21",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<KeywordRetrieveResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        KeywordRetrieveResponse copied = new(model);
