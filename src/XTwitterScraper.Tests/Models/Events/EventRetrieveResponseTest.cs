...
public class EventRetrieveResponseTest : TestBase
{
    ...
    {
        var model = new Events::EventRetrieveResponse
        {
            ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<Events::EventRetrieveResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        Events::EventRetrieveResponse copied = new(model);
